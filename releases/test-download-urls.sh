...
check "Node.js 24.17.0  linux-arm64   (arm64)" \
  "https://nodejs.org/dist/v24.18.1/node-v24.18.1-linux-arm64.tar.gz"
check "Node.js 24.17.0  linux-s390x   (s390x)" \
  "https://nodejs.org/dist/v24.18.1/node-v24.18.1-linux-s390x.tar.gz"
check "Node.js 24.17.0  linux-ppc64le (ppc64el)" \
  "https://nodejs.org/dist/v24.18.1/node-v24.18.1-linux-ppc64le.tar.gz"
echo ""
