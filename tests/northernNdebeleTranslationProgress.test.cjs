...
assert.match(ndebele['list-width-error-message'], /yinombolo epheleleyo okungenani amaphikseli angu-200/);
assert.doesNotMatch(ndebele['list-width-error-message'], /270/);
