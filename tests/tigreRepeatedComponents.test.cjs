...
const reviewed = {
  ...
  "see-all-starred-items": "ክሎም ኮኾብ ዝተገብረሎም ኣቕንዖት ርአ",
  "delete-all-notifications": "ክሎም ምልክታታት ደምስስ",
  "delete-duplicate-lists-confirm": "ርግጸኛ ዲኻ? እዚ ሓደ ስም ዘለዎምን ካርድ ዘይሓዙን ክሎም ተደጋገምቲ ዝርዝራት ክድምስስ እዩ።",
  ...
  "accounts-allowUserDelete": "መትነፍዓይ መለያኡ ባዕሉ ይደምስስ",
