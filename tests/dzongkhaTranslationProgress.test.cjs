...
assert.match(dzongkha['migrate-all-to-gridfs'], /GridFS/);
assert.match(dzongkha['migrate-all-to-s3'], /S3/);
assert.match(dzongkha['migration-batch-size-description'], /1-100/);
