...
//
// Design: docs/Features/All-Boards/Workspaces.md
...
test('the design doc exists, and every file it lists does too', () => {
  const doc = read('docs/Features/All-Boards/Workspaces.md');
  ...
  assert.ok(/\(Workspaces\.md\)/.test(read('docs/Features/All-Boards/All-Boards.md')),
