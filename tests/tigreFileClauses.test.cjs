...
const reviewed = {
  ...
  "api-upload-limit-label": "ዝለዓለ ዓቐን ፈይል ምስቃል API",
  "api-download-limit-label": "ዝለዓለ ዓቐን ፈይል ምውራድ API",
  "allowed-avatar-filetypes": "ዝፍቀዱ ዓይነታት ፈይል ስእሊ መንነት፦",
  "gcs-key-filename": "መንገዲ ፈይል መፍትሕ መለያ ኣገልግሎት",
  "gridfs-enabled-description": "ንመኽዘን ፈይል MongoDB GridFS ተጠቐም",
  "s3-enabled-description": "ንመኽዘን ፈይል AWS S3 ወይ MinIO ተጠቐም"
};
