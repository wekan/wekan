...
BlazeComponent.extendComponent({
  ...
  isBoardSelected(){
    return this.currentBoard.assigneeDefaultBoardID
  },

  isNullBoardSelected() {
    return (
      this.currentBoard.assigneeDefaultBoardId === null ||
      this.currentBoard.assigneeDefaultBoardId === undefined
    );
  },
  ...
  isListSelected() {
    return this.currentBoard.assigneeDefaultBoardId === this.currentData()._id;
  },
...
}).register('boardAssigneeSettingsPopup');
