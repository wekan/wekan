...
async function readExportFile(file) {
  ...
  // ZIP imports are dispatched to the streaming server route before this
  // helper is called. Refuse a future accidental browser-side unpack instead
  // of pulling a second ZIP implementation into every board chunk.
  throw new Error('import-zip-must-stream-to-server');
}
