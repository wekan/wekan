...
BlazeComponent.extendComponent({
  ...
  onCreated() {
    ...
    Utils.getBoardComponent(this).showOverlay.set(true);
    Utils.getBoardComponent(this).mouseHasEnterCardDetails = false;
  ...
  onDestroyed() {
    Utils.getBoardComponent(this).showOverlay.set(false);
  },
  ...
  events() {
    ...
    return [{
      ...
      'mouseenter .js-card-details' () {
        Utils.getBoardComponent(this).showOverlay.set(true);
        Utils.getBoardComponent(this).mouseHasEnterCardDetails = true;
      },
      'click #toggleButton'() {
