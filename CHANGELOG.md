...
remaining work is **72,166 values across 34 second-tier languages**. Southern
Sotho is complete after forty-two 50-value batches and a final 24-value batch.
Tajik has 374 left after its first thirty-six 50-value batches. Albanian and
...
**Tajik translations** now cover their first thirty-six activity, workspace,
...
lockout and database-migration batches;
