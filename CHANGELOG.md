...
findings: 15,243 corrected, 4,058 restored pre-pull values awaiting
validation, 179 reviewed and retained, and 601 pending review or repair.
The correction inventory records 17,507 exact before/after values,
including repairs outside the original findings.
All 361 originally flagged Klingon findings are repaired. The broader review of 829
German-identical Klingon values repaired all 829, including the mistaken
German cron label, which now uses the actual tool name Cron.
The largest original queues are Standard Moroccan Tamazight (458) and
...
Latest translation fix is dc90fc0f7 (2026-09-14), replacing the Arabic
used-email warning and French username import action. Preserve address
scope and import direction; predicate agreement, plural forms and import
imperative remain low confidence pending fluent review.
...
remain open. There are 458 Tamazight findings remaining.
...
Translation audit progress as of 2026-09-14: 15,243 original findings are
corrected, 179 reviewed and retained, 4,058 restored values await validation,
and 601 remain pending across 17 locales, including 458 Tamazight findings.
The ledger contains 17,507 correction records, including unflagged repairs.
