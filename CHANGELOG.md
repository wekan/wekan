...
remaining work is **69,018 values across 32 second-tier languages**. Southern
...
batch. Tigre has 1,574 left after its first twelve 50-value batches. Albanian
...
backups and migrations; **Tigre translations** cover their first twelve batches
spanning activity, boards, roles, email, exports, filters and import formats;
