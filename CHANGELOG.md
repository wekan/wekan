...
remaining work is **73,716 values across 34 second-tier languages**. Southern
Sotho is complete after forty-two 50-value batches and a final 24-value batch.
Tajik has 1,924 left after its first five 50-value batches. Albanian and Bosnian are
also complete:
...
**Tajik translations** now cover their first five activity, workspace, board
layout, administration, view and archive batches;
