...
remaining work is **72,416 values across 34 second-tier languages**. Southern
Sotho is complete after forty-two 50-value batches and a final 24-value batch.
Tajik has 624 left after its first thirty-one 50-value batches. Albanian and
...
**Tajik translations** now cover their first thirty-one activity, workspace,
...
role-management, card-view, global-search, dependency, location, recovery and
report batches;
