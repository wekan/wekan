...
remaining work is **71,042 values across 33 second-tier languages**. Southern
...
Tigrinya has 1,424 left after its first fifteen 50-value batches. Albanian and
...
**Tigrinya translations** now cover their first fifteen activity, workspace,
...
multi-selection, privacy and shortcuts;
