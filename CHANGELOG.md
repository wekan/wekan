...
remaining work is **69,518 values across 32 second-tier languages**. Southern
...
batch. Tigre has 2,074 left after its first two 50-value batches. Albanian and
...
backups and migrations; **Tigre translations** cover their first two activity
and workspace batches;
