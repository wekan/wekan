...
remaining work is **73,416 values across 34 second-tier languages**. Southern
Sotho is complete after forty-two 50-value batches and a final 24-value batch.
Tajik has 1,624 left after its first eleven 50-value batches. Albanian and Bosnian are
also complete:
...
**Tajik translations** now cover their first eleven activity, workspace, board,
role, custom-field, email, validation, export and filter batches;
