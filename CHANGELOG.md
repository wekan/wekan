...
remaining work is **73,566 values across 34 second-tier languages**. Southern
Sotho is complete after forty-two 50-value batches and a final 24-value batch.
Tajik has 1,774 left after its first eight 50-value batches. Albanian and Bosnian are
also complete:
...
**Tajik translations** now cover their first eight activity, workspace, board,
voting, member-mapping, theme, card-aging and color batches;
