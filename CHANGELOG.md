...
remaining work is **71,916 values across 34 second-tier languages**. Southern
Sotho is complete after forty-two 50-value batches and a final 24-value batch.
Tajik has 124 left after its first forty-one 50-value batches. Albanian and
...
**Tajik translations** now cover their first forty-one activity, workspace,
