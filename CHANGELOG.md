...
remaining work is **74,840 values across 35 second-tier languages**. Southern
Sotho has 874 left after its first twenty-five 50-value batches. Albanian and
...
translations** now cover their first twenty-five activity, administration,
automation, interface, shared-view and search batches;
