...
remaining work is **75,590 values across 35 second-tier languages**. Southern
Sotho has 1,624 left after its first ten 50-value batches. Albanian and
...
translations** now cover their first ten activity, administration, role,
email, validation, export and filter batches;
