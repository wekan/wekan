...
remaining work is **69,842 values across 33 second-tier languages**. Southern
...
Tigrinya has 224 left after its first thirty-nine 50-value batches. Albanian
...
**Tigrinya translations** now cover their first thirty-nine batches spanning
boards and cards, workflows, import/export, search, administration, security,
recovery, file and cloud storage, data safety, backups and migrations;
