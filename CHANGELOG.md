...
remaining work is **71,592 values across 33 second-tier languages**. Southern
...
Tigrinya has 1,974 left after its first four 50-value batches. Albanian and
...
**Tigrinya translations** now cover their first four activity, workspace,
sizing, archive and board-settings batches;
