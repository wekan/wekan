...
remaining work is **74,190 values across 35 second-tier languages**. Southern
Sotho has 224 left after its first thirty-eight 50-value batches. Albanian and
...
translations** now cover their first thirty-eight activity, administration,
automation, security, backup, cloud-storage and storage-migration batches;
