...
remaining work is **74,290 values across 35 second-tier languages**. Southern
Sotho has 324 left after its first thirty-six 50-value batches. Albanian and
...
translations** now cover their first thirty-six activity, administration,
automation, storage, migration, security and backup batches;
