...
remaining work is **70,742 values across 33 second-tier languages**. Southern
...
Tigrinya has 1,124 left after its first twenty-one 50-value batches. Albanian
...
**Tigrinya translations** now cover their first twenty-one activity, workspace,
...
and filters plus cross-platform and resumable Trello imports, archives and
multi-selection, privacy, shortcuts, tracking, branding, limits, webhooks,
system details, organizations, cards, subtasks and scheduled automation rules;
