...
remaining work is **74,740 values across 35 second-tier languages**. Southern
Sotho has 774 left after its first twenty-seven 50-value batches. Albanian and
...
translations** now cover their first twenty-seven activity, administration,
automation, interface and global-search batches;
