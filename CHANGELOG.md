...
remaining work is **75,090 values across 35 second-tier languages**. Southern
Sotho has 1,124 left after its first twenty 50-value batches. Albanian and
...
translations** now cover their first twenty activity, administration, system,
card, automation-builder and scheduled-automation batches;
