...
findings: 15,155 corrected, 4,058 restored pre-pull values awaiting
validation, 179 reviewed and retained, and 689 pending review or repair.
The correction inventory records 17,366 exact before/after values,
including repairs outside the original findings.
All 361 originally flagged Klingon findings are repaired. The broader review of 829
German-identical Klingon values repaired all 829, including the mistaken
German cron label, which now uses the actual tool name Cron.
The largest original queues are Standard Moroccan Tamazight (546) and
...
Latest translation fix is c60ea35b7 (2026-09-14), replacing three French
member-selection, full-card list-display and per-list card-count labels.
Complete phrases, derived noun forms and kanban terminology remain low
confidence. Earlier composed activity, search-link, board-renaming, label,
...
remain open. There are 546 Tamazight findings remaining.
...
Translation audit progress as of 2026-09-14: 15,155 original findings are
corrected, 179 are reviewed and retained, 4,058 restored values await
validation, and 689 original findings remain pending across 17 locales.
Of those pending findings, 546 are Tamazight. Repairs found outside the
