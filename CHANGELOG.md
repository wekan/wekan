...
remaining work is **69,992 values across 33 second-tier languages**. Southern
...
Tigrinya has 374 left after its first thirty-six 50-value batches. Albanian
...
**Tigrinya translations** now cover their first thirty-six batches spanning
boards and cards, workflows, import/export, search, administration, security,
recovery and file and cloud storage;
