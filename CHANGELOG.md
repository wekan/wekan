...
remaining work is **70,292 values across 33 second-tier languages**. Southern
...
Tigrinya has 674 left after its first thirty 50-value batches. Albanian
...
**Tigrinya translations** now cover their first thirty activity,
...
instructions plus dependencies, backgrounds, maps and problem reports;
