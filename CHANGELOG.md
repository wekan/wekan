...
remaining work is **73,990 values across 35 second-tier languages**. Southern
Sotho has 24 left after its first forty-two 50-value batches. Albanian and
...
translations** now cover their first forty-two activity, administration,
automation, security, migration, monitoring, account and repair batches;
