...
remaining work is **70,042 values across 33 second-tier languages**. Southern
...
Tigrinya has 424 left after its first thirty-five 50-value batches. Albanian
...
**Tigrinya translations** now cover their first thirty-five activity,
...
checklists, attachment storage, board details, support, accessibility and
lockout protection;
