...
remaining work is **67,244 values across 31 second-tier languages**. Southern
...
24-value batch.
Tswana has 1,974 left after its first four 50-value batches.
...
**Tswana translations** cover their first four board-activity, workspace,
board-sizing, archive and display batches.
