...
remaining work is **73,366 values across 34 second-tier languages**. Southern
Sotho is complete after forty-two 50-value batches and a final 24-value batch.
Tajik has 1,574 left after its first twelve 50-value batches. Albanian and Bosnian are
also complete:
...
**Tajik translations** now cover their first twelve activity, workspace, board,
role, email, validation, export, filter and multi-source import batches;
