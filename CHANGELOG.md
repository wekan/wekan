...
findings: 15,152 corrected, 4,058 restored pre-pull values awaiting
validation, 179 reviewed and retained, and 692 pending review or repair.
The correction inventory records 17,363 exact before/after values,
including repairs outside the original findings.
All 361 originally flagged Klingon findings are repaired. The broader review of 829
German-identical Klingon values repaired all 829, including the mistaken
German cron label, which now uses the actual tool name Cron.
The largest original queues are Standard Moroccan Tamazight (549) and
...
Latest translation fix is 4f37e7278 (2026-09-14), replacing the French
search-link and Arabic board-renaming labels. Complete demonstrative and
board genitive phrases and kanban terminology remain low confidence.
Earlier composed activity, label, filename, credential and export wording
...
remain open. There are 549 Tamazight findings remaining.
...
Translation audit progress as of 2026-09-14: 15,152 original findings are
corrected, 179 are reviewed and retained, 4,058 restored values await
validation, and 692 original findings remain pending across 17 locales.
Of those pending findings, 549 are Tamazight. Repairs found outside the
