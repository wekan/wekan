...
remaining work is **72,366 values across 34 second-tier languages**. Southern
Sotho is complete after forty-two 50-value batches and a final 24-value batch.
Tajik has 574 left after its first thirty-two 50-value batches. Albanian and
...
**Tajik translations** now cover their first thirty-two activity, workspace,
...
report, memory and checklist batches;
