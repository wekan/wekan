...
remaining work is **73,466 values across 34 second-tier languages**. Southern
Sotho is complete after forty-two 50-value batches and a final 24-value batch.
Tajik has 1,674 left after its first ten 50-value batches. Albanian and Bosnian are
also complete:
...
**Tajik translations** now cover their first ten activity, workspace, board,
theme, card-aging, role, custom-field, email and validation batches;
