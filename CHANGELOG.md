...
remaining work is **73,066 values across 34 second-tier languages**. Southern
Sotho is complete after forty-two 50-value batches and a final 24-value batch.
Tajik has 1,274 left after its first eighteen 50-value batches. Albanian and Bosnian are
also complete:
...
**Tajik translations** now cover their first eighteen activity, workspace,
board, notification, upload, template, transfer-limit, webhook, system and
organization-settings batches;
