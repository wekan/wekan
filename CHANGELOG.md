...
remaining work is **71,542 values across 33 second-tier languages**. Southern
...
Tigrinya has 1,924 left after its first five 50-value batches. Albanian and
...
**Tigrinya translations** now cover their first five activity, workspace,
sizing, archive, board-settings and view batches;
