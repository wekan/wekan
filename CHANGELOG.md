...
remaining work is **70,992 values across 33 second-tier languages**. Southern
...
Tigrinya has 1,374 left after its first sixteen 50-value batches. Albanian and
...
**Tigrinya translations** now cover their first sixteen activity, workspace,
...
multi-selection, privacy, shortcuts, tracking and branding;
