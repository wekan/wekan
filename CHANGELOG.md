...
remaining work is **72,316 values across 34 second-tier languages**. Southern
Sotho is complete after forty-two 50-value batches and a final 24-value batch.
Tajik has 524 left after its first thirty-three 50-value batches. Albanian and
...
**Tajik translations** now cover their first thirty-three activity, workspace,
...
report, memory, checklist and attachment-storage batches;
