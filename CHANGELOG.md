...
remaining work is **74,790 values across 35 second-tier languages**. Southern
Sotho has 824 left after its first twenty-six 50-value batches. Albanian and
...
translations** now cover their first twenty-six activity, administration,
automation, interface, shared-view and global-search batches;
