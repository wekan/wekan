...
remaining work is **73,666 values across 34 second-tier languages**. Southern
Sotho is complete after forty-two 50-value batches and a final 24-value batch.
Tajik has 1,874 left after its first six 50-value batches. Albanian and Bosnian are
also complete:
...
**Tajik translations** now cover their first six activity, workspace, board,
administration, voting, dependency and import batches;
