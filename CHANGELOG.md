...
remaining work is **71,292 values across 33 second-tier languages**. Southern
...
Tigrinya has 1,674 left after its first ten 50-value batches. Albanian and
...
**Tigrinya translations** now cover their first ten activity, workspace,
sizing, archive, board-settings, view, voting, import, mapping and theme
batches plus card aging, colors, roles, custom fields, email and errors;
