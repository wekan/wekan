...
remaining work is **69,318 values across 32 second-tier languages**. Southern
...
batch. Tigre has 1,874 left after its first six 50-value batches. Albanian and
...
backups and migrations; **Tigre translations** cover their first six activity,
workspace, board, voting, dependency and import batches;
