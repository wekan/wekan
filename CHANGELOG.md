...
remaining work is **70,942 values across 33 second-tier languages**. Southern
...
Tigrinya has 1,324 left after its first seventeen 50-value batches. Albanian and
...
**Tigrinya translations** now cover their first seventeen activity, workspace,
...
multi-selection, privacy, shortcuts, tracking, branding, limits and webhooks;
