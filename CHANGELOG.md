...
remaining work is **74,240 values across 35 second-tier languages**. Southern
Sotho has 274 left after its first thirty-seven 50-value batches. Albanian and
...
translations** now cover their first thirty-seven activity, administration,
automation, migration, security, backup and cloud-storage batches;
