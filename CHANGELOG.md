...
remaining work is **74,340 values across 35 second-tier languages**. Southern
Sotho has 374 left after its first thirty-five 50-value batches. Albanian and
...
translations** now cover their first thirty-five activity, administration,
automation, storage, accessibility, scheduled-job and migration batches;
