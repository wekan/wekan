...
remaining work is **75,140 values across 35 second-tier languages**. Southern
Sotho has 1,174 left after its first nineteen 50-value batches. Albanian and
...
translations** now cover their first nineteen activity, administration,
system, card, subtask and automation-builder batches;
