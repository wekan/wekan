...
remaining work is **71,342 values across 33 second-tier languages**. Southern
...
Tigrinya has 1,724 left after its first nine 50-value batches. Albanian and
...
**Tigrinya translations** now cover their first nine activity, workspace,
sizing, archive, board-settings, view, voting, import, mapping and theme
batches plus card aging, colors, roles and custom fields;
