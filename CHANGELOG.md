...
findings: 15,258 corrected, 4,058 restored pre-pull values awaiting
validation, 179 reviewed and retained, and 586 pending review or repair.
The correction inventory records 17,544 exact before/after values,
including repairs outside the original findings.
All 361 originally flagged Klingon findings are repaired. The broader review of 829
German-identical Klingon values repaired all 829, including the mistaken
German cron label, which now uses the actual tool name Cron.
The largest original queues are Standard Moroccan Tamazight (443) and
...
Latest translation fix is 305503e7e (2026-09-14), repairing three
email-test/template values. Preserve test qualifier, sending to oneself,
plural templates and email scope. Math-to-email-test adaptation, bound nouns,
reflexive recipient and full phrases remain low confidence.
...
remain open. There are 443 Tamazight findings remaining.
...
Translation audit progress as of 2026-09-14: 15,258 original findings are
corrected, 179 reviewed and retained, 4,058 restored values await validation,
and 586 remain pending across 17 locales, including 443 Tamazight findings.
The ledger contains 17,544 correction records, including unflagged repairs.
