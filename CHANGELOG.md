...
findings: 15,257 corrected, 4,058 restored pre-pull values awaiting
validation, 179 reviewed and retained, and 587 pending review or repair.
The correction inventory records 17,541 exact before/after values,
including repairs outside the original findings.
All 361 originally flagged Klingon findings are repaired. The broader review of 829
German-identical Klingon values repaired all 829, including the mistaken
German cron label, which now uses the actual tool name Cron.
The largest original queues are Standard Moroccan Tamazight (444) and
...
Latest translation fix is 2921a4e3d (2026-09-14), repairing four
organization labels/error values. Preserve plural add/list, singular
settings, missing named organization and exact %s placeholder. The lexicon
marks organization vocabulary MW (Mammeri); dialect adaptation, spelling,
feminine negation and full phrases remain low confidence.
...
remain open. There are 444 Tamazight findings remaining.
...
Translation audit progress as of 2026-09-14: 15,257 original findings are
corrected, 179 reviewed and retained, 4,058 restored values await validation,
and 587 remain pending across 17 locales, including 444 Tamazight findings.
The ledger contains 17,541 correction records, including unflagged repairs.
