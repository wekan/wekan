...
remaining work is **70,792 values across 33 second-tier languages**. Southern
...
Tigrinya has 1,174 left after its first twenty 50-value batches. Albanian and
...
**Tigrinya translations** now cover their first twenty activity, workspace,
...
system details, organizations, cards, subtasks and automation rules;
