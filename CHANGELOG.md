...
remaining work is **73,516 values across 34 second-tier languages**. Southern
Sotho is complete after forty-two 50-value batches and a final 24-value batch.
Tajik has 1,724 left after its first nine 50-value batches. Albanian and Bosnian are
also complete:
...
**Tajik translations** now cover their first nine activity, workspace, board,
member-mapping, theme, card-aging, role and custom-field batches;
