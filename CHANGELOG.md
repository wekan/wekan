...
findings: 15,260 corrected, 4,058 restored pre-pull values awaiting
validation, 179 reviewed and retained, and 584 pending review or repair.
The correction inventory records 17,551 exact before/after values,
including repairs outside the original findings.
All 361 originally flagged Klingon findings are repaired. The broader review of 829
German-identical Klingon values repaired all 829, including the mistaken
German cron label, which now uses the actual tool name Cron.
The largest original queues are Standard Moroccan Tamazight (441) and
...
Latest translation fix is 0619954f5 (2026-09-14), repairing seven
team/name-error values. Preserve already-used organization/team names versus
missing team, singular/plural labels, add action and exact %s token. Free
plural, software/dialect adaptation, bound nouns and complete errors remain
...
remain open. There are 441 Tamazight findings remaining.
...
Translation audit progress as of 2026-09-14: 15,260 original findings are
corrected, 179 reviewed and retained, 4,058 restored values await validation,
and 584 remain pending across 17 locales, including 441 Tamazight findings.
The ledger contains 17,551 correction records, including unflagged repairs.
