...
remaining work is **71,492 values across 33 second-tier languages**. Southern
...
Tigrinya has 1,874 left after its first six 50-value batches. Albanian and
...
**Tigrinya translations** now cover their first six activity, workspace,
sizing, archive, board-settings, view, voting and import batches;
