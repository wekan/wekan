...
remaining work is **72,716 values across 34 second-tier languages**. Southern
Sotho is complete after forty-two 50-value batches and a final 24-value batch.
Tajik has 924 left after its first twenty-five 50-value batches. Albanian and
...
**Tajik translations** now cover their first twenty-five activity, workspace,
