...
remaining work is **70,442 values across 33 second-tier languages**. Southern
...
Tigrinya has 824 left after its first twenty-seven 50-value batches. Albanian
...
**Tigrinya translations** now cover their first twenty-seven activity,
...
and role status plus shared and due card views and global search terms;
