...
remaining work is **73,316 values across 34 second-tier languages**. Southern
Sotho is complete after forty-two 50-value batches and a final 24-value batch.
Tajik has 1,524 left after its first thirteen 50-value batches. Albanian and Bosnian are
also complete:
...
**Tajik translations** now cover their first thirteen activity, workspace,
board, validation, export, filter and multi-source and Trello import batches;
