...
remaining work is **74,140 values across 35 second-tier languages**. Southern
Sotho has 174 left after its first thirty-nine 50-value batches. Albanian and
...
translations** now cover their first thirty-nine activity, administration,
automation, security, backup, storage-migration and board-repair batches;
