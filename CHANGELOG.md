...
remaining work is **69,742 values across 33 second-tier languages**. Southern
...
Tigrinya has 124 left after its first forty-one 50-value batches. Albanian
...
**Tigrinya translations** now cover their first forty-one batches spanning
