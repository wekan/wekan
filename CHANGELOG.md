...
remaining work is **68,568 values across 32 second-tier languages**. Southern
...
batch. Tigre has 1,124 left after its first twenty-one 50-value batches.
...
backups and migrations; **Tigre translations** cover their first twenty-one
