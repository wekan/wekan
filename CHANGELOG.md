...
findings: 15,077 corrected, 4,058 restored pre-pull values awaiting
validation, 179 reviewed and retained, and 767 pending review or repair.
The correction inventory records 17,180 exact before/after values,
including repairs outside the original findings.
All 361 originally flagged Klingon findings are repaired. The broader review of 829
German-identical Klingon values repaired all 829, including the mistaken
German cron label, which now uses the actual tool name Cron.
The largest original finding queues remain in Veps (30) and Standard Moroccan
...
Latest translation fix is 70921d116 (2026-09-14), covering nine Veps wait-animation
