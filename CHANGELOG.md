...
remaining work is **72,966 values across 34 second-tier languages**. Southern
Sotho is complete after forty-two 50-value batches and a final 24-value batch.
Tajik has 1,174 left after its first twenty 50-value batches. Albanian and Bosnian are
also complete:
...
**Tajik translations** now cover their first twenty activity, workspace,
