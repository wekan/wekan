...
remaining work is **69,468 values across 32 second-tier languages**. Southern
...
batch. Tigre has 2,024 left after its first three 50-value batches. Albanian and
...
backups and migrations; **Tigre translations** cover their first three activity,
workspace and board-layout batches;
