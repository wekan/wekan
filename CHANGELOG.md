...
remaining work is **75,440 values across 35 second-tier languages**. Southern
Sotho has 1,474 left after its first thirteen 50-value batches. Albanian and
...
translations** now cover their first thirteen activity, administration, email,
import, list, archive and selection-control batches;
