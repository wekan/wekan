...
- It's possible to use Wekan with Friend. At 2019-06-30 Wekan also works at [Raspberry Pi](../../HW/RaspberryPi/Raspberry-Pi.md) like Friend already works, it makes possible local RasPi-only network.
...
There is also Friend iOS app, but I think it's not yet officially released. If someone is interested, invite to iOS Testflight can be had from [Friend chat](README.md).
