...
[Build from source on Mac](../../Propietary/OS/Mac)

## Build from source on VirtualBox

At [Virtual Appliance](../Container/VirtualBox) there is build scripts and all dependencies installed already.
...
Wekan Meteor Bundle:
1. [Build from source scripts](https://github.com/wekan/wekan/tree/edge/releases/virtualbox) built on [Wekan VirtualBox Ubuntu 14.04 64bit](../Container/VirtualBox)
...
Wekan on Windows:
- [Docker, Windows Subsystem for Linux, and compile from source on Windows](../../Propietary/OS/Windows)
