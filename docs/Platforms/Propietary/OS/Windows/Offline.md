Also see: [Windows](README.md)

[Other CPU/OS On-Premise WeKan install](../../../FOSS/HW/RaspberryPi/Raspberry-Pi.md)
...
1. [wekan-11.27-win64.zip](https://github.com/wekan/wekan/releases/download/v11.27/wekan-11.27-win64.zip) or newest available at https://github.com/wekan/wekan/releases/
...
7. Unzip `wekan-11.27-win64.zip` , inside it is directory `bundle`, to it copy other files:
...
[virtual appliance](../../../FOSS/Container/VirtualBox#how-to-use)
