...
./start-wekan.sh
```
More info at [Raspberry Pi](../../../FOSS/HW/RaspberryPi/Raspberry-Pi.md)
...
[Related VM info how to expose port with bridged networking](../../../FOSS/Container/VirtualBox)
