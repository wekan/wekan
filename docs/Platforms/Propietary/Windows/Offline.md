...
1. [wekan-8.73-win64.zip](https://github.com/wekan/wekan/releases/download/v8.73/wekan-8.73-win64.zip)
...
7. Unzip `wekan-8.73-win64.zip` , inside it is directory `bundle`, to it copy other files:
