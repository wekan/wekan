...
1. [wekan-9.64-win64.zip](https://github.com/wekan/wekan/releases/download/v9.64/wekan-9.64-win64.zip) or newest available at https://github.com/wekan/wekan/releases/
...
7. Unzip `wekan-9.64-win64.zip` , inside it is directory `bundle`, to it copy other files:
