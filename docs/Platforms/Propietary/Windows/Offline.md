...
1. [wekan-7.79-amd64-windows.zip](https://github.com/wekan/wekan/releases/download/v7.79/wekan-7.79-amd64-windows.zip)
...
7. Unzip `wekan-7.79-amd64-windows.zip` , inside it is directory `bundle`, to it copy other files:
