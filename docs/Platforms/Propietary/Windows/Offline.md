...
1. [wekan-9.03-win64.zip](https://github.com/wekan/wekan/releases/download/v9.03/wekan-9.03-win64.zip)
...
7. Unzip `wekan-9.03-win64.zip` , inside it is directory `bundle`, to it copy other files:
