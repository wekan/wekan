...
1. [wekan-8.85-win64.zip](https://github.com/wekan/wekan/releases/download/v8.85/wekan-8.85-win64.zip)
...
7. Unzip `wekan-8.85-win64.zip` , inside it is directory `bundle`, to it copy other files:
