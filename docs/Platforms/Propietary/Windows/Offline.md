...
1. [wekan-8.09-amd64-windows.zip](https://github.com/wekan/wekan/releases/download/v8.09/wekan-8.09-amd64-windows.zip)
...
7. Unzip `wekan-8.09-amd64-windows.zip` , inside it is directory `bundle`, to it copy other files:
