...
1. [wekan-9.00-win64.zip](https://github.com/wekan/wekan/releases/download/v9.00/wekan-9.00-win64.zip)
...
7. Unzip `wekan-9.00-win64.zip` , inside it is directory `bundle`, to it copy other files:
