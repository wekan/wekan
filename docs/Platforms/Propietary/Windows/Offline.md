...
1. [wekan-10.31-win64.zip](https://github.com/wekan/wekan/releases/download/v10.31/wekan-10.31-win64.zip) or newest available at https://github.com/wekan/wekan/releases/
...
7. Unzip `wekan-10.31-win64.zip` , inside it is directory `bundle`, to it copy other files:
