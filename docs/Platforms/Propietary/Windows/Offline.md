...
1. [wekan-7.78-amd64-windows.zip](https://github.com/wekan/wekan/releases/download/v7.78/wekan-7.78-amd64-windows.zip)
...
7. Unzip `wekan-7.78-amd64-windows.zip` , inside it is directory `bundle`, to it copy other files:
