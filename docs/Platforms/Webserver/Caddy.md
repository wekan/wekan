...
[Sandstorm](../FOSS/Container/Sandstorm)

## Caddy 2

WeKan Snap Candidate for any Snap distros: [OpenSuse](../FOSS/OS/OpenSuse.md) , disable internal old Caddy 1, when using Caddy 2:
```
...
[Caddy OAuth2 with Let's Encrypt SSL example](../../Features/Login/OAuth2.md)
