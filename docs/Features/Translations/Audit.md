...
| --- | ---: |
| Corrected | 15,538 |
| Restored pre-pull; awaiting validation | 3,828 |
| Reviewed; retained unchanged | 407 |
...
Restored Danish wording review (2026-09-14, latest `2250b6716`): reviewed
230 values: 228 retained unchanged and two diagnostic meanings repaired.
Latest review preserves migration continuation/warnings, batch range, counters,
temporary lockout cause and later retry. Danish orange remains unchanged.
Now 407 original findings are reviewed/retained and 3,828 restored values
