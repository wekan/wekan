...
Latest translation fix: **2026-09-14**, local commit `a47e7141d` —
Arabic accept and French invitation status become Tamazight drafts with
not-yet meaning preserved. Four checks pass; secondary verb provenance
and passive grammar remain low confidence. Pending: 238.

The [correction ledger](../../../releases/translations/audited-corrections.json)
records contain **18,798** exact before/after values, including unflagged
...
| --- | ---: |
| zgh — Standard Moroccan Tamazight | 130 |
| iu — Inuktitut | 38 |
| nah — Nahuatl | 17 |
| tig — Tigre | 17 |
| wal — Wolaytta | 17 |
