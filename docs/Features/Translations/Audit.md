...
| Status | Audit keys |
| --- | ---: |
| Explicitly corrected | 5,814 |
| Original pull values restored to pre-pull local values | 4,061 |
| Reviewed and retained unchanged | 94 |
| Pending review or repair | 10,114 |
| Total tracked | 20,081 |

**Translation repairs remain unfinished.** These counts cover flagged findings; unflagged strings and restored values are not certified as correct.

Repairs cover wrong-language text, kanban terminology, omitted restrictions and warnings, JSON examples, placeholders, calendar names and search/date formatting. The correction history records **5,876 values**, including fixes outside the audit. Flagged Bosnian, Croatian, Macedonian, Slovenian (both locales), Latvian, Romanian, Slovak and both Galician queues are complete.

Latest fix: [d82b649d7](https://github.com/wekan/wekan/commit/d82b649d764ad4892eab063dba855ea5238195eb), **2026-09-13** — eight Asturian custom-field, subtask and deletion-warning corrections. Repairs preserve irreversible history loss, linked-card deletion order and the team-membership restriction. **397 Asturian findings remain.** Meaning, exact-value, placeholder, key-order and idempotency checks pass; Asturian wording needs native-speaker review. Live Meteor browser verification remains unavailable.
