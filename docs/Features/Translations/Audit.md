...
contain **18,683** exact before/after values, including unflagged repairs.
...
open in `5400a0ce9`. Current pending/restored counts are 287/9.
...
Current pending/restored counts are 287/9.

Latest translation fix: **2026-09-14**, local commit `8422804a4` —
Tamazight Buddhist calendar replaces English with an adapted native label.
The native adjective is attested in a directly fetched community article;
full compound and browser review remain open. All 18,683 corrections and
focused checks pass. One original finding is corrected: 287 pending and
9 restored remain. Earlier Inuktitut commands are in `b8e746289`.
...
open. Counts are 287 pending and 9 restored. Earlier S3 review is in
...
pending/restored counts are 287/9.
...
| --- | ---: |
| zgh — Standard Moroccan Tamazight | 172 |
| iu — Inuktitut | 40 |
| nah — Nahuatl | 17 |
| tig — Tigre | 17 |
| wal — Wolaytta | 17 |
