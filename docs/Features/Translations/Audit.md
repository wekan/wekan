...
Latest fix: [2adbe678f](https://github.com/wekan/wekan/commit/2adbe678f786e05619feaf03b516f66f5d24f718), **2026-09-13** — eight Asturian label, membership and list-archive corrections. Repairs preserve irreversible label history loss, board-exit consequences, archive restoration paths and all-card selection scope. **343 Asturian findings remain.** Meaning, exact-value, placeholder, key-order and idempotency checks pass; Asturian wording needs native-speaker review. Live Meteor browser verification remains unavailable.
