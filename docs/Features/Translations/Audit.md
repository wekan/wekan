...
Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **15,987** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-13**, local commit `56f8ce913` — replaced eight unflagged Finnish-seeded Veps basic color labels with attested Veps vocabulary and added positive/negative language regression checks. Specialized shades still require semantic review. Previous validation `10d3b3515` checked counted-duration inflection. Original Venetian and main Venda findings are repaired; restored/unflagged values and wider linguistic review continue.
