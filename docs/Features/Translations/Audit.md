...
Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **16,111** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-13**, local commit `c938208a8` — repaired Finnish Veps hour/minute/second and lockout-duration labels with native software-attested units. Existing Veps ZIP-size warning was preserved. Composed duration wording needs fluent review. All **16,111** correction records and vocabulary/token checks pass. Veps has 594 original findings remaining. Year-warning digit terminology, lockout/calendar compositions, broader wrong-language/script values, restored translations and browser verification remain outstanding.
