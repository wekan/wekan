...
| Status | Audit keys |
| --- | ---: |
| Explicitly corrected | 5,944 |
| Original pull values restored to pre-pull local values | 4,061 |
| Reviewed and retained unchanged | 97 |
| Pending review or repair | 9,981 |
| Total tracked | 20,081 |

**Translation repairs remain unfinished.** These counts cover flagged findings; unflagged strings and restored values are not certified as correct.

Repairs cover wrong-language text, kanban terminology, omitted restrictions and warnings, JSON examples, placeholders, calendar names and search/date formatting. The correction history records **6,006 values**, including fixes outside the audit. Flagged Bosnian, Croatian, Macedonian, Slovenian (both locales), Latvian, Romanian, Slovak and both Galician queues are complete.

Latest fix: [9a9a411ab](https://github.com/wekan/wekan/commit/9a9a411ab4825994ea0714206db0fcff8ca1c995), **2026-09-13** — nine Asturian diagnostic, date and accessibility corrections; three valid technical labels retained unchanged. Repairs clarify uptime, storage-engine and date/time meanings while preserving shared vocabulary. **264 Asturian findings remain.** Meaning, unchanged-review, exact-value, placeholder, key-order and idempotency checks pass; Asturian wording needs native-speaker review. Live Meteor browser verification remains unavailable.
