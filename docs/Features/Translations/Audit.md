...
| --- | ---: |
| Corrected | 15,561 |
| Restored pre-pull; awaiting validation | 1,284 |
| Reviewed; retained unchanged | 2,928 |
...
and HTML-placement values. All **18,161** correction and **2,928** review
...
Latest unchanged review: **2026-09-14**, commit `c45e99b02` — retained
30 correct Galician date filters, import formats and member mapping values.
