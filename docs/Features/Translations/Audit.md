...
| Pending review or repair | 1,457 |
...
Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **15,897** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-13**, local commit `73c8cb4b0` — replaced 20 Italian-seeded Venetian import-mapping, keyboard, label and list messages. Preserved unmapped-member fallback, enabled/disabled states, last-admin guard and irreversible loss warnings. Direct wording remains low confidence pending fluent-speaker review. Venetian has **75** original findings remaining. Main Venda original findings are repaired in `180ca33c5`; restored and unflagged values still require validation. Wider repairs continue.
