...
| --- | ---: |
| Corrected | 15,561 |
| Restored pre-pull; awaiting validation | 1,433 |
| Reviewed; retained unchanged | 2,779 |
...
and HTML-placement values. All **18,161** correction and **2,779** review
...
Latest unchanged review: **2026-09-14**, commit `708478423` — retained
30 correct Galician display settings, archive and zoom controls.
