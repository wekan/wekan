...
| Pending review or repair | 1,339 |
| Total tracked | 20,081 |

**Resumed at the maintainer’s request on 2026-09-13.** Reviewing and repairing the remaining local findings, beginning with Klingon. All **361** originally flagged Klingon findings are repaired. The broader check of **829** German-identical values is reviewed: **829** repaired, including the mistaken German `cron` retention corrected to the actual tool name **Cron**. Restored and unflagged translations still need validation.

Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **16,085** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-13**, local commit `90b6e57bb` — repaired six Finnish Veps known/unknown/locked-user messages, preserving username/password conditions, current lock state and successful unlock. Dictionary inflections and native software vocabulary supply the reference; composed grammar needs fluent review. All **16,085** correction records and vocabulary/token checks pass. Veps has 598 original findings remaining. Year-warning digit terminology, calendar compositions, broader wrong-language/script values, restored translations and browser verification remain outstanding.
