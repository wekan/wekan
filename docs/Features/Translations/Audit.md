...
| Status | Audit keys |
| --- | ---: |
| Explicitly corrected | 5,307 |
| Original pull values restored to pre-pull local values | 4,061 |
| Reviewed and retained unchanged | 78 |
| Pending review or repair | 10,635 |
| Total tracked | 20,081 |

**Translation repairs remain unfinished.** These counts cover flagged findings; unflagged strings and restored values are not certified as correct.

Repairs cover wrong-language text, kanban terminology, omitted restrictions and warnings, JSON examples, placeholders, calendar names and search/date formatting. The correction history records **5,369 values**, including fixes outside the audit. Flagged Bosnian, Croatian, Macedonian, Slovenian (both locales), Latvian, Romanian and Slovak queues are complete.

Latest fix: [03b8a8a4f](https://github.com/wekan/wekan/commit/03b8a8a4fd2961b95437049fd568e71e6b3d609e), **2026-09-13** — 16 Galician regional notification, search-error, visibility and invitation corrections. Repairs restore the positive-integer limit requirement and preserve notification scope, member-only editing and invitation placeholders. **383 regional findings remain.** Meaning, exact-value, placeholder, key-order and idempotency checks pass; live Meteor browser verification remains unavailable.
