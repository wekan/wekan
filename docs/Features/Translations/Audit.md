...
| Pending review or repair | 2,588 |
...
Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **14,763** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-13**, local commit `9b78486c5` — replaced six English Luganda and Fijian calendar labels, preserving Coptic identity and civil versus astronomical Hijri epochs. Specialized wording is low confidence and awaits fluent-speaker review. The preceding Swati/Northern Sotho/Tsonga fix is `e077f92b9`. Klingon fix `1044eebc9` completed the broader German-seed review; **1,189** Klingon values were repaired since resumption. Reviewed shared technical names remain protected. Wider repairs continue.
