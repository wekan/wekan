...
Latest translation correction: [d98e80bb3](https://github.com/wekan/wekan/commit/d98e80bb3055435858c111bddd2fb5197a1a71db), **2026-09-13**, fixes six Galician regional credential, invitation, member-fallback and label values. Reviewed Galician wording preserves unmapped-member fallback, username/password alternatives, irreversible all-card label deletion and history loss. The regional queue has 427 findings remaining. Meaning, exact-value, placeholder, key-order and idempotency checks pass.
