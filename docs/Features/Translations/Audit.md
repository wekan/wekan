...
Latest translation fix: **2026-09-13**, local commit `1c53f96ad` — corrected the mistaken Klingon `cron` retention: German **Zeitplan** was replaced by the actual technical name **Cron**, the erroneous retained-review record was removed and positive/negative regression coverage added. All 829 German-identical Klingon candidates are now repaired. Original Venetian and main Venda findings are repaired; restored and unflagged values still require validation. Wider repairs continue.
