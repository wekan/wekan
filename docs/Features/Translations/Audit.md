...
Latest translation fix: **2026-09-14**, local commit `c0edf1104` —
Arabic hidden-activities notification is repaired in Tamazight, retaining
both all-activities and all-boards scopes. Four checks pass; full native
plural grammar and browser validation remain open. Pending: 261.

The [correction ledger](../../../releases/translations/audited-corrections.json)
records contain **18,740** exact before/after values, including unflagged
...
| --- | ---: |
| zgh — Standard Moroccan Tamazight | 148 |
| iu — Inuktitut | 38 |
| nah — Nahuatl | 17 |
| tig — Tigre | 17 |
| wal — Wolaytta | 17 |
