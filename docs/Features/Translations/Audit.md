...
| Pending review or repair | 1,335 |
| Total tracked | 20,081 |

**Resumed at the maintainer’s request on 2026-09-13.** Reviewing and repairing the remaining local findings, beginning with Klingon. All **361** originally flagged Klingon findings are repaired. The broader check of **829** German-identical values is reviewed: **829** repaired, including the mistaken German `cron` retention corrected to the actual tool name **Cron**. Restored and unflagged translations still need validation.

Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **16,118** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-13**, local commit `47150ef05` — replaced seven Finnish Veps recurring schedule labels, preserving interval numbers and units. **Low confidence:** native vocabulary is attested, but composed frequency grammar needs fluent review. All **16,118** correction records and vocabulary/token/interval checks pass. These unflagged repairs leave original pending counts unchanged. Year-warning digit terminology, lockout/calendar compositions, broader wrong-language/script values, restored translations and browser verification remain outstanding.
