...
Latest translation fix: **2026-09-15**, `0ef3ca6dd` — repair the missed exact
Organizations control after `08e7092c3` replaced established
File, User, Name, Label, Organization, Team, Path, Status, Size, Color and
Count components across all 193 matching Tigre values. The follow-up brings this family to 194 repairs. English source-sense
guards preserve unrelated Icon and Clipboard meanings. Derived File, Name,
...
2,592 non-English Tigre values, 243 are byte-for-byte identical to Tigrinya;
22 are corpus-attested shared terms and 221 remain unclassified, including 25
...
records contain **21,889** exact before/after values, including unflagged
