...
Latest translation fix: **2026-09-15**, `27dbc30c2` — replace Arabic
private-page login guidance, preserving uncertainty and anchor/%s.
Four focused suites pass. Ledger 19,858; pending 160 (Tamazight 65),
restored 4 unchanged. Derived private adjective and conditional clause
remain low confidence; broader reviews remain open.

The [correction ledger](../../../releases/translations/audited-corrections.json)
records contain **19,858** exact before/after values, including unflagged
...
| --- | ---: |
| zgh — Standard Moroccan Tamazight | 65 |
| iu — Inuktitut | 38 |
| nah — Nahuatl | 17 |
| tig — Tigre | 17 |
| wal — Wolaytta | 10 |
