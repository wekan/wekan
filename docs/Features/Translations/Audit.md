...
| Pending review or repair | 2,594 |
...
Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **14,757** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-13**, local commit `e077f92b9` — replaced ten English calendar labels in Swati, Northern Sotho and Tsonga, preserving calendar identities and civil versus astronomical Hijri epochs. Specialized wording is low confidence and awaits fluent-speaker review. The preceding Kirundi/Ndebele fix is `2a750c70c`. Klingon fix `1044eebc9` completed the broader German-seed review; **1,189** Klingon values were repaired since resumption. Reviewed shared technical names remain protected. Wider repairs continue.
