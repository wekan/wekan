...
Latest translation fix: **2026-09-15**, `3ce7ed2a0` — replace French
due-card empty states and unflagged generic no-cards-found text.
Four focused suites pass. Ledger 19,848; pending 168 (Tamazight 73),
restored 4 unchanged. Negative passive agreement and the existing
due-date compound remain low confidence; broader reviews remain open.

The [correction ledger](../../../releases/translations/audited-corrections.json)
records contain **19,848** exact before/after values, including unflagged
...
| --- | ---: |
| zgh — Standard Moroccan Tamazight | 73 |
| iu — Inuktitut | 38 |
| nah — Nahuatl | 17 |
| tig — Tigre | 17 |
| wal — Wolaytta | 10 |
