...
Latest translation fix: **2026-09-15**, `53fba5240` — Tamazight Planning
Poker deletion warning replaces French. Preserve irreversibility and loss
of all associated actions using the existing warning construction. Four
focused suites pass. Ledger 19,827; original pending 185 (Tamazight 90),
restored 4 unchanged. Complete grammar and permanence/association wording
remain low confidence; broader reviews remain open.

The [correction ledger](../../../releases/translations/audited-corrections.json)
records contain **19,827** exact before/after values, including unflagged
...
| --- | ---: |
| zgh — Standard Moroccan Tamazight | 90 |
| iu — Inuktitut | 38 |
| nah — Nahuatl | 17 |
| tig — Tigre | 17 |
| wal — Wolaytta | 10 |
