...
Latest translation fix: **2026-09-14**, local commit `a4439d400` —
Tamazight top/bottom rule fragments replace unflagged French using primary
position nouns. Four checks pass; assembled native/browser grammar remains
low confidence. Original pending: 258.

The [correction ledger](../../../releases/translations/audited-corrections.json)
records contain **18,756** exact before/after values, including unflagged
...
| --- | ---: |
| zgh — Standard Moroccan Tamazight | 145 |
| iu — Inuktitut | 38 |
| nah — Nahuatl | 17 |
| tig — Tigre | 17 |
| wal — Wolaytta | 17 |
