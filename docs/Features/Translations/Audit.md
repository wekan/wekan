...
| Pending review or repair | 3,496 |
| Total tracked | 20,081 |

**Repairs remain unfinished.** Restored and unflagged values still need validation.

Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **12,879** exact before/after values, including repairs outside the audit.

Latest translation fix: **2026-09-13**, local commit `720cd85dd2806777c74ec3b2c08018aabc3850bf` — six Volapük custom-translation controls repaired, preserving string scope, count and deletion question. Assembled wording remains low confidence.
