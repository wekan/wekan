...
| Status | Audit keys |
| --- | ---: |
| Explicitly corrected | 5,744 |
| Original pull values restored to pre-pull local values | 4,061 |
| Reviewed and retained unchanged | 94 |
| Pending review or repair | 10,184 |
| Total tracked | 20,081 |

**Translation repairs remain unfinished.** These counts cover flagged findings; unflagged strings and restored values are not certified as correct.

Repairs cover wrong-language text, kanban terminology, omitted restrictions and warnings, JSON examples, placeholders, calendar names and search/date formatting. The correction history records **5,806 values**, including fixes outside the audit. Flagged Bosnian, Croatian, Macedonian, Slovenian (both locales), Latvian, Romanian, Slovak and both Galician queues are complete.

Latest fix: [942ed9d1f](https://github.com/wekan/wekan/commit/942ed9d1ff6e14c6330890f551aa48a74fb880e1), **2026-09-13** — ten Asturian restoration, custom-field and checklist-state corrections. Repairs distinguish unchecked/incomplete states from completion and preserve card context and value placeholders. **467 Asturian findings remain.** Meaning, exact-value, placeholder, key-order and idempotency checks pass; Asturian wording needs native-speaker review. Live Meteor browser verification remains unavailable.
