...
| Pending review or repair | 3,103 |
| Total tracked | 20,081 |

**Repairs remain unfinished.** Restored and unflagged values still need validation.

Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **13,370** exact before/after values, including repairs outside the audit.

Latest translation fix: **2026-09-13**, local commit `1b41036ba355e2466112e125d73b4f38424fc97d` — four German/French permanent-deletion warnings (three flagged findings) replaced with Klingon, preserving irreversibility, history/activity loss and all-notification confirmation. Full software wording is low confidence and needs fluent-speaker validation.
