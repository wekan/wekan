...
Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **13,518** exact before/after values, including repairs outside the audit.

Latest translation fix: **2026-09-13**, local commit `8dcef884a5beaebe4847acb2ab24683ee5e230ea` — seven German movement/import/membership activity fragments (three flagged findings) replaced with Klingon, preserving template argument order and source/destination roles. Full software wording is low confidence and needs fluent-speaker validation.
