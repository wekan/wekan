...
Latest translation fix: **2026-09-15**, `8378f9f39` — Tamazight empty-
duplicate-list description translated, retaining no cards AND a same-title
populated counterpart. Four focused suites pass. Ledger 19,776; original
pending 207 (zgh 104), restored 4 unchanged. Full relative/restriction grammar
and all other uncertain/restored findings remain open.

The [correction ledger](../../../releases/translations/audited-corrections.json)
records contain **19,776** exact before/after values, including unflagged
...
| --- | ---: |
| zgh — Standard Moroccan Tamazight | 104 |
| iu — Inuktitut | 38 |
| nah — Nahuatl | 17 |
| tig — Tigre | 17 |
| wal — Wolaytta | 17 |
