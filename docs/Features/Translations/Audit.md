...
Latest translation fix: **2026-09-15**, `f9d9c454d` — replace seven
unflagged Tshivenda two-factor setup/login messages with Veps drafts.
Preserve every-login codes, QR/manual alternatives, six digits and retry.
Four focused files pass (29 checks). Ledger 19,935; original pending
126/restored 4 unchanged. Computing compounds and complete grammar
remain low confidence; broader flagged/unflagged review is still open.

The [correction ledger](../../../releases/translations/audited-corrections.json)
records contain **19,935** exact before/after values, including unflagged
