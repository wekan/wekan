...
| Status | Audit keys |
| --- | ---: |
| Explicitly corrected | 6,229 |
| Restored pre-pull values awaiting further validation | 4,059 |
| Reviewed and retained unchanged | 100 |
| Pending review or repair | 9,693 |
| Total tracked | 20,081 |

**Translation repairs remain unfinished.** These counts cover flagged findings; unflagged strings and restored values are not certified as correct.

Fixes cover wrong-language text, terminology, missing warnings, JSON examples, placeholders and calendar/search formatting. The correction history records **6,291 values**, including fixes outside the audit. Flagged Bosnian, Croatian, Macedonian, Slovenian (both locales), Latvian, Romanian, Slovak both Galician and Asturian queues are complete.

Latest fix: [245193f6e](https://github.com/wekan/wekan/commit/245193f6e92cb6645b907698c177788a976df6e2), **2026-09-13** — six Aragonese storage, backup-selection, board-lookup, template-container and scheduled-job corrections; select-first and successful-deletion meanings preserved. **325 Aragonese findings remain.** Meaning, exact-value, placeholder, key-order and idempotency checks pass; Aragonese and Asturian wording need native-speaker review. Live Meteor browser verification remains unavailable.
