...
Latest translation fix: **2026-09-13**, local commit `ffbf2ef72` — repaired Veps calendar and selector labels using **kalendar'**, attested in actual Veps newspaper/corpus text. Removed Finnish and Turkic-seeded wording. Compound selector terminology remains low confidence pending fluent-speaker review. Veps has **626** original findings remaining. Original Venetian and main Venda findings are repaired; restored/unflagged values and wider linguistic review continue.
