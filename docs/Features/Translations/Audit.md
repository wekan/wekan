...
Latest translation correction: [10cc133fe](https://github.com/wekan/wekan/commit/10cc133fe9fae65f03d524264bedf76092a7fd98), **2026-09-13**, fixes six Galician regional list, member, modified-date, organization, swimlane and team operator values. Reviewed Galician wording preserves board-scoped organization/team matching, inclusive day limits and list/swimlane distinctions. The regional queue has 451 findings remaining. Meaning, exact-value, placeholder, key-order and idempotency checks pass.
