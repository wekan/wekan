...
Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **17,591** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-14**, local commit `14bcae938` — repaired four original French/Arabic attachment count/filesystem-move findings. Preserve minicard count, singular/all/all-of-board attachment scope and filesystem destination. The lexicon explicitly names a filesystem; system and Kabyle mail-attachment vocabulary adaptation, transcription, bound nouns and full software phrases remain **low confidence** pending review. All **17,591** correction/rendering checks pass. **556** originals remain pending across **17** locales, including **413** Tamazight. Restored/unflagged values and earlier low-confidence wording still need validation. Live browser verification was not run; no translations were pushed.
