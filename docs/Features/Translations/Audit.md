...
Latest translation fix: **2026-09-15**, `9680e2393` — Tamazight PDF
preview warning replaces Arabic. Preserve device inability to preview and
the alternative of trying a download. Four focused suites pass. Ledger
19,832; original pending 181 (Tamazight 86), restored 4 unchanged.
Full capability, preview and alternative phrasing remain low confidence;
broader reviews remain open.

The [correction ledger](../../../releases/translations/audited-corrections.json)
records contain **19,832** exact before/after values, including unflagged
...
| --- | ---: |
| zgh — Standard Moroccan Tamazight | 86 |
| iu — Inuktitut | 38 |
| nah — Nahuatl | 17 |
| tig — Tigre | 17 |
| wal — Wolaytta | 10 |
