...
| Status | Audit keys |
| --- | ---: |
| Explicitly corrected | 5,884 |
| Original pull values restored to pre-pull local values | 4,061 |
| Reviewed and retained unchanged | 94 |
| Pending review or repair | 10,044 |
| Total tracked | 20,081 |

**Translation repairs remain unfinished.** These counts cover flagged findings; unflagged strings and restored values are not certified as correct.

Repairs cover wrong-language text, kanban terminology, omitted restrictions and warnings, JSON examples, placeholders, calendar names and search/date formatting. The correction history records **5,946 values**, including fixes outside the audit. Flagged Bosnian, Croatian, Macedonian, Slovenian (both locales), Latvian, Romanian, Slovak and both Galician queues are complete.

Latest fix: [6820358a1](https://github.com/wekan/wekan/commit/6820358a1ec337d2557bf28f881ef3b4eb6b1325), **2026-09-13** — eight Asturian notification, visibility and permission corrections. Repairs preserve normal-user settings restrictions, watched-item scope, private-board access and empty-state meanings. **327 Asturian findings remain.** Meaning, exact-value, placeholder, key-order and idempotency checks pass; Asturian wording needs native-speaker review. Live Meteor browser verification remains unavailable.
