...
| Pending review or repair | 710 |
| Total tracked | 20,081 |

**Resumed at the maintainer’s request on 2026-09-13.** Reviewing and repairing the remaining local findings, beginning with Klingon. All **361** originally flagged Klingon findings are repaired. The broader check of **829** German-identical values is reviewed: **829** repaired, including the mistaken German `cron` retention corrected to the actual tool name **Cron**. Restored and unflagged translations still need validation.

Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **17,333** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-14**, local commit `81f487305` — refined three earlier Tamazight lockout-filter/comment-confirmation corrections using native Mastodon blocked-user and deletion-question morphology. Previously derived plural and want/delete clause forms are replaced with directly attested forms. Full combined filter usage and comment-object substitution remain **low confidence** pending fluent review. Original before-values and ledger count are preserved. All **17,333** correction/rendering checks pass. Counts remain **710** originals pending, including **567** Tamazight. Broader restored/unflagged and composed terminology validation remains open. Live browser verification was not run; no translations were pushed.
