...
| --- | ---: |
| Corrected | 15,536 |
| Restored pre-pull; awaiting validation | 3,978 |
| Reviewed; retained unchanged | 259 |
...
Restored Danish wording review (2026-09-14, latest `eb1f433e2`): reviewed
and retained 80 complete values unchanged, including search operators,
inclusive day ranges, missing values, descending sorting, archive defaults,
exact troubleshooting commands, warnings, directions and counts. Now 259
original findings are reviewed/retained and 3,978 restored values await
