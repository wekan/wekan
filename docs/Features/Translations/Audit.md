...
Latest translation fix: **2026-09-15**, `ecbe3856d` — replace Arabic
legacy permanent-attachment warning using added-file paraphrase and an
explicit no-undo clause. Active soft-delete wording remains separate.
Four focused suites pass. Ledger 19,855; pending 163 (Tamazight 68),
restored 4 unchanged. Adverbial permanence and passive grammar remain
low confidence; broader reviews remain open.

The [correction ledger](../../../releases/translations/audited-corrections.json)
records contain **19,855** exact before/after values, including unflagged
...
| --- | ---: |
| zgh — Standard Moroccan Tamazight | 68 |
| iu — Inuktitut | 38 |
| nah — Nahuatl | 17 |
| tig — Tigre | 17 |
| wal — Wolaytta | 10 |
