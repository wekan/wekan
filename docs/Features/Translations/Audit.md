...
| Pending review or repair | 1,729 |
...
Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **15,625** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-13**, local commit `6d05bb764` — replaced 19 Italian-seeded Venetian archive, visibility and custom-content labels, preserving irreversible deletion warnings, logged-in access meaning and HTML tags. Direct wording is low confidence pending fluent-speaker review. Venetian has **347** original findings remaining, including advanced-filter instructions requiring literal-syntax correction. Main Venda original findings are repaired in `180ca33c5`; restored and unflagged values still require validation. Wider repairs continue.
