...
| Pending review or repair | 698 |
| Total tracked | 20,081 |

**Resumed at the maintainer’s request on 2026-09-13.** Reviewing and repairing the remaining local findings, beginning with Klingon. All **361** originally flagged Klingon findings are repaired. The broader check of **829** German-identical values is reviewed: **829** repaired, including the mistaken German `cron` retention corrected to the actual tool name **Cron**. Restored and unflagged translations still need validation.

Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **17,348** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-14**, local commit `f25f84ade` — replaced two French Tamazight values: the cards-or-lists filter command and the currently-empty locked-user status. Preserve OR scope and the current-time qualifier. Native component terms support the repairs; full phrases, kanban card plural and login-lockout terminology remain **low confidence** pending fluent review. All **17,348** correction/rendering checks pass. **698** originals remain pending, including **555** Tamazight. Earlier composed wording and restored/unflagged values still need validation. Live browser verification was not run; no translations were pushed.
