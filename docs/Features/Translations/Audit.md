...
| Pending review or repair | 3,018 |
| Total tracked | 20,081 |

**Repairs remain unfinished.** Restored and unflagged values still need validation.

Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **13,488** exact before/after values, including repairs outside the audit.

Latest translation fix: **2026-09-13**, local commit `3325e7d2beba1c508dcd3ef4d21f61e94da45799` — six German organization/team controls (three flagged findings) replaced with Klingon, preserving counts, edit identities and administrator-contact instruction. Full software wording is low confidence and needs fluent-speaker validation.
