...
| Pending review or repair | 660 |
| Total tracked | 20,081 |

**Resumed at the maintainer’s request on 2026-09-13.** Reviewing and repairing the remaining local findings, beginning with Klingon. All **361** originally flagged Klingon findings are repaired. The broader check of **829** German-identical values is reviewed: **829** repaired, including the mistaken German `cron` retention corrected to the actual tool name **Cron**. Restored and unflagged translations still need validation.

Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **17,408** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-14**, local commit `803d6f74d` — replaced French in the invalid-sort diagnostic and Arabic in the generic Sort label. Native MediaWiki directly attests the sort noun and invalid-value components. Preserve `%s` exactly and invalid-sort meaning, distinct from invalid operators, statuses and limits. Complete diagnostic/genitive agreement remains **low confidence** pending fluent review. All **17,408** correction/rendering checks pass. One original and one unflagged finding are repaired: **660** originals remain pending across **17** locales, including **517** Tamazight. Remaining operator/predicate/limit terminology requires further research. Restored/unflagged values and earlier low-confidence wording still need validation. Live browser verification was not run; no translations were pushed.
