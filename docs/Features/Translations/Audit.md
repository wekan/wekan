...
| --- | ---: |
| Corrected | 15,538 |
| Restored pre-pull; awaiting validation | 3,739 |
| Reviewed; retained unchanged | 496 |
...
Restored Danish wording review (2026-09-14, latest `c6d3b9e0e`): reviewed
319 values: 317 retained unchanged and two diagnostic meanings repaired.
Latest review preserves OR versus AND search logic, literal examples, matching
scopes, pagination and date predicates. Ambiguous export free remains open.
Now 496 original findings are reviewed/retained and 3,739 restored values
