...
| Pending review or repair | 678 |
| Total tracked | 20,081 |

**Resumed at the maintainer’s request on 2026-09-13.** Reviewing and repairing the remaining local findings, beginning with Klingon. All **361** originally flagged Klingon findings are repaired. The broader check of **829** German-identical values is reviewed: **829** repaired, including the mistaken German `cron` retention corrected to the actual tool name **Cron**. Restored and unflagged translations still need validation.

Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **17,387** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-14**, local commit `599d26b4f` — replaced two French Tamazight password-reset and email-verification subjects, preserving `__siteName__` exactly. MediaWiki directly attests the reset-password command and component verification/email-address terms. Full subjects, possessive attachment and verification verb dialect spelling remain **low confidence** pending fluent review. All **17,387** correction/rendering checks pass. Two original findings are repaired: **678** originals remain pending across **17** locales, including **535** Tamazight. Mail-failure and success sentences still need complete terminology and inflection review. Earlier composed wording and restored/unflagged values still need validation. Live browser verification was not run; no translations were pushed.
