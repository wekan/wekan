...
| Pending review or repair | 1,687 |
...
Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **15,667** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-13**, local commit `8d669c209` — replaced 16 Italian-seeded Venetian invitation, board-permission, deletion and ordering messages. Preserved member/admin distinctions, irreversible warnings, email placeholders and line breaks. Direct wording remains low confidence pending fluent-speaker review. Venetian has **305** original findings remaining. Main Venda original findings are repaired in `180ca33c5`; restored and unflagged values still require validation. Wider repairs continue.
