...
contain **18,402** exact before/after values, including unflagged repairs.
[Detailed evidence](Audit-Evidence.md) retains categorized findings,
source references, confidence limits and archived progress notes.

Latest translation fix: **2026-09-14**, local commit `3bddd8e14` —
seven French-seeded Breton date-rule fields and activity labels repaired
using existing date/hour terminology. Start, due, end and received fields
remain distinct. All **18,402** corrections and 4,158 unchanged reviews pass
structural checks. Native assembled grammar and browser review remain open,
alongside other wrong-language values, Galician attachment agreement and
provisional calendar terminology.
