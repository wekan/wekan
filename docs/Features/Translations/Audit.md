...
| Pending review or repair | 3,664 |
| Total tracked | 20,081 |

**Repairs remain unfinished.** Counts cover flagged findings; restored and unflagged translations are not certified as correct.

Fixes address wrong-language text, terminology, warnings, placeholders, JSON examples and calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **12,638** exact before/after values, including repairs outside the audit.

Latest translation fix: **2026-09-13**, local commit `d2f1b9508f21800b7dbfbf53c499941db47b0488` — six French upload/file-limit/test-email labels repaired in Volapük using [MediaWiki software terminology](https://raw.githubusercontent.com/wikimedia/mediawiki/master/languages/i18n/vo.json) and existing vocabulary. Preserved allowed types, maximum byte limits, upload completion and self-addressed test email; assembled wording remains low confidence.
