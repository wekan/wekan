...
Latest translation fix: **2026-09-14**, local commit `91ebdcc27` —
Tamazight Trello import prose is translated; menu names, their order and
JSON are preserved. Four checks pass. Full native wording and browser
validation stay open. Pending original findings: 264.

The [correction ledger](../../../releases/translations/audited-corrections.json)
records contain **18,737** exact before/after values, including unflagged
...
| --- | ---: |
| zgh — Standard Moroccan Tamazight | 151 |
| iu — Inuktitut | 38 |
| nah — Nahuatl | 17 |
| tig — Tigre | 17 |
| wal — Wolaytta | 17 |
