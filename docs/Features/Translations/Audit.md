...
Latest translation fix: **2026-09-15**, `3fd9413b3` — replace Arabic
member-removal confirmation, preserving placeholders, all board cards
and notification. Four focused suites pass. Ledger 19,863;
pending 155 (Tamazight 62), restored 4 unchanged. Notification/passive
and full contextual grammar remain low confidence; broader reviews open.

The [correction ledger](../../../releases/translations/audited-corrections.json)
records contain **19,863** exact before/after values, including unflagged
...
| --- | ---: |
| zgh — Standard Moroccan Tamazight | 62 |
| iu — Inuktitut | 38 |
| nah — Nahuatl | 17 |
| tig — Tigre | 17 |
| wal — Wolaytta | 10 |
