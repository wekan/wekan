...
and action/title agreement. Four checks pass; native/browser review is open.

The [correction ledger](../../../releases/translations/audited-corrections.json)
records contain **18,725** exact before/after values, including unflagged
...
| --- | ---: |
| zgh — Standard Moroccan Tamazight | 159 |
| iu — Inuktitut | 38 |
| nah — Nahuatl | 17 |
| tig — Tigre | 17 |
| wal — Wolaytta | 17 |
