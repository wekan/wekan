...
| Pending review or repair | 1,568 |
...
Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **15,786** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-13**, local commit `7a48f1a32` — replaced 20 Italian-seeded Venetian administration, archive and upload messages. Preserved active/inactive states, offline data-loss warning, HTML tags and size placeholders. Direct wording remains low confidence pending fluent-speaker review. Venetian has **186** original findings remaining. Main Venda original findings are repaired in `180ca33c5`; restored and unflagged values still require validation. Wider repairs continue.
