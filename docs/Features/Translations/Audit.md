...
| Pending review or repair | 1,363 |
| Total tracked | 20,081 |

**Resumed at the maintainer’s request on 2026-09-13.** Reviewing and repairing the remaining local findings, beginning with Klingon. All **361** originally flagged Klingon findings are repaired. The broader check of **829** German-identical values is reviewed: **829** repaired, including the mistaken German `cron` retention corrected to the actual tool name **Cron**. Restored and unflagged translations still need validation.

Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **16,023** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-13**, local commit `3d8f20733` — repaired all six flagged Tibetan calendar findings and two related Gregorian/ISO labels. Hijri variants preserve civil/astronomical epoch and lunar-sighting distinctions. All **16,023** exact correction records and vocabulary checks pass. Technical composition/transliterations have low confidence; Member Settings UI coverage is syntax-checked, browser execution pending. Veps has 616 flagged findings remaining; wider wrong-language Veps/Acehnese and Uzbek Arabic repairs remain outstanding.
