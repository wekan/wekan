...
| Pending review or repair | 3,769 |
| Total tracked | 20,081 |

**Repairs remain unfinished.** Counts cover flagged findings; restored and unflagged translations are not certified as correct.

Fixes address wrong-language text, terminology, warnings, placeholders, JSON examples and calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **12,522** exact before/after values, including repairs outside the audit.

Latest translation fix: **2026-09-13**, local commit `4cad8f842d09cda2eee7393bb68e14497ec80f9e` — four French/Esperanto invitation action/subject/body and self-invitation error values repaired in Volapük using [Midgley vocabulary](https://www.markfoster.net/dcf/Volapuk_Dictionary.pdf). Preserved inviter/recipient/board/URL tokens, quoted board name and paragraph separators. Board-membership phrase and assembled grammar remain low confidence. Exact-value, token, JSON-example, key-order, paragraph-format and idempotency checks pass; native-speaker and browser verification remain unavailable.
