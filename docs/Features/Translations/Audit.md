...
Latest translation fix: **2026-09-15**, `8362a8a2e` — replace French
custom head-tag activation label with Tamazight activate and custom-tag
wording. Borrowed `head (HTML)` keeps document scope explicit.
Four focused suites pass. Ledger 19,841; pending 173 (Tamazight 78),
restored 4 unchanged. Full software compound remains low confidence;
broader reviews remain open.

The [correction ledger](../../../releases/translations/audited-corrections.json)
records contain **19,841** exact before/after values, including unflagged
...
| --- | ---: |
| zgh — Standard Moroccan Tamazight | 78 |
| iu — Inuktitut | 38 |
| nah — Nahuatl | 17 |
| tig — Tigre | 17 |
| wal — Wolaytta | 10 |
