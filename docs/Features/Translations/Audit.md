...
Latest translation fix: **2026-09-15**, `b7f18f9ce` — Wolaytta Ethiopian
calendar drafts replace English while preserving the distinct Amete Alem
era. Four focused suites pass. Ledger 19,787; original pending 201
(Wolaytta 15), restored 4 unchanged. Complete country-calendar grammar
and all broader uncertain reviews remain open.

The [correction ledger](../../../releases/translations/audited-corrections.json)
records contain **19,787** exact before/after values, including unflagged
