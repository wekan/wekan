...
Latest translation correction: [bede4fb47](https://github.com/wekan/wekan/commit/bede4fb479a469d9d91d14d9254fdbc66cd987fd), **2026-09-13**, fixes 10 Galician regional attachment, watching, new-card-field and board-archive values containing Portuguese. Reuses individually reviewed Galician wording, preserving new/all-card distinctions, archive scheduling success/failure and mini-card attachment counts. The Galician regional queue has 571 findings remaining. Meaning, exact-value, token, key-order and idempotent repair checks pass.
