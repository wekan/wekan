...
Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **15,989** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-13**, local commit `a5577d919` — replaced unflagged Finnish-seeded Veps Add/Added labels with the dictionary-attested imperative **Ližada** and passive participle **Ližatud**; positive/negative language regressions pass. Previous `56f8ce913` repaired eight basic colors. The 626 original Veps findings, specialized shades, restored/unflagged values and wider linguistic review remain outstanding.
