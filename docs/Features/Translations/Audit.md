...
| --- | ---: |
| Corrected | 15,562 |
| Restored pre-pull; awaiting validation | 990 |
| Reviewed; retained unchanged | 3,221 |
...
All **18,162** correction and **3,221** review records pass. Attachment/member rule participles need context-specific
...
Latest unchanged review: **2026-09-14**, commit `d2d90abf5` — retained
30 correct Galician query syntax, sorting and troubleshooting values.
