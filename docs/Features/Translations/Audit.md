...
| Status | Audit keys |
| --- | ---: |
| Explicitly corrected | 5,405 |
| Original pull values restored to pre-pull local values | 4,061 |
| Reviewed and retained unchanged | 78 |
| Pending review or repair | 10,537 |
| Total tracked | 20,081 |

**Translation repairs remain unfinished.** These counts cover flagged findings; unflagged strings and restored values are not certified as correct.

Repairs cover wrong-language text, kanban terminology, omitted restrictions and warnings, JSON examples, placeholders, calendar names and search/date formatting. The correction history records **5,467 values**, including fixes outside the audit. Flagged Bosnian, Croatian, Macedonian, Slovenian (both locales), Latvian, Romanian and Slovak queues are complete.

Latest fix: [60364ccc1](https://github.com/wekan/wekan/commit/60364ccc13af1e5f52aac7f53ca81d22ecdc5259), **2026-09-13** — 23 Galician regional account, worker-permission and diagnostics corrections. Repairs preserve username requirements and restricted worker actions, distinguish heap from stack and correct the storage-engine label. **285 regional findings remain.** Meaning, exact-value, placeholder, key-order and idempotency checks pass; live Meteor browser verification remains unavailable.
