...
Latest translation correction: [39e438417](https://github.com/wekan/wekan/commit/39e438417768234c2a72673734d695225458edc4), **2026-09-13**, fixes 10 Galician regional template-copy, custom-field, cover and input-instruction values containing Portuguese. Reuses individually reviewed Galician wording, preserving literal JSON fields, checklist aliases and irreversible all-card field deletion/history loss. The Galician regional queue has 511 findings remaining. JSON parsing, meaning, exact-value, token, key-order and idempotent repair checks pass.
