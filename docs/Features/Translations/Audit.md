...
| Status | Audit keys |
| --- | ---: |
| Explicitly corrected | 6,323 |
| Restored pre-pull values awaiting further validation | 4,059 |
| Reviewed and retained unchanged | 107 |
| Pending review or repair | 9,592 |
| Total tracked | 20,081 |

**Translation repairs remain unfinished.** These counts cover flagged findings; unflagged strings and restored values are not certified as correct.

Fixes cover wrong-language text, terminology, missing warnings, JSON examples, placeholders and calendar/search formatting. The correction history records **6,385 values**, including fixes outside the audit. Flagged Bosnian, Croatian, Macedonian, Slovenian (both locales), Latvian, Romanian, Slovak both Galician and Asturian queues are complete.

Latest fix: [fc0300f6b](https://github.com/wekan/wekan/commit/fc0300f6bf95196553a2b35ccec9c74a2a14f7ef), **2026-09-13** — six Aragonese checklist, job-cleanup, clipboard and comment corrections; folding a checklist remains distinct from deleting it. **224 Aragonese findings remain.** Meaning, exact-value, placeholder, key-order and idempotency checks pass; Aragonese and Asturian wording need native-speaker review. Live Meteor browser verification remains unavailable.
