...
Latest translation fix: **2026-09-15**, `d90707d5d` — replace Arabic
blank rule-field instruction with computing matching terminology.
Keep empty field and every possible value. Four focused suites pass.
Ledger 19,854; pending 164 (Tamazight 69), restored 4 unchanged.
Derived matching noun and full grammar remain low confidence;
broader reviews remain open.

The [correction ledger](../../../releases/translations/audited-corrections.json)
records contain **19,854** exact before/after values, including unflagged
...
| --- | ---: |
| zgh — Standard Moroccan Tamazight | 69 |
| iu — Inuktitut | 38 |
| nah — Nahuatl | 17 |
| tig — Tigre | 17 |
| wal — Wolaytta | 10 |
