...
| Pending review or repair | 1,336 |
| Total tracked | 20,081 |

**Resumed at the maintainer’s request on 2026-09-13.** Reviewing and repairing the remaining local findings, beginning with Klingon. All **361** originally flagged Klingon findings are repaired. The broader check of **829** German-identical values is reviewed: **829** repaired, including the mistaken German `cron` retention corrected to the actual tool name **Cron**. Restored and unflagged translations still need validation.

Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **16,107** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-13**, local commit `45045afae` — repaired Finnish Veps notification, Delete All Notifications and description labels using dictionary-attested tedotuzed and native software vocabulary. Composed deletion wording needs fluent review; uncertain comment borrowings remain open. All **16,107** correction records and vocabulary/token checks pass. Veps has 595 original findings remaining. Year-warning digit terminology, lockout/calendar compositions, broader wrong-language/script values, restored translations and browser verification remain outstanding.
