...
| Pending review or repair | 4,029 |
| Total tracked | 20,081 |

**Repairs remain unfinished.** Counts cover flagged findings; restored and unflagged translations are not certified as correct.

Fixes address wrong-language text, terminology, warnings, placeholders, JSON examples and calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **12,199** exact before/after values, including repairs outside the audit.

Latest translation fix: **2026-09-13**, local commit `85e9cd8d719b77637de3926fc55dc5e919a2c87e` — 7 Rundi labels repaired: setting, Hebrew, Dangi, Hijri/Umm al-Qura, Minguo and Gregorian ISO weeks. Hebrew wording and week vocabulary are attested; other assembled grammar remains low confidence. Religious/country/tabular variants still need review. Exact-value, placeholder, JSON-example, key-order and idempotency checks pass; live browser verification is unavailable.
