...
Repairs address wrong-language text, incorrect kanban terminology, missing restrictions and warnings, malformed JSON examples, translated placeholders, calendar names, search syntax and date/message argument order. The reviewed correction list contains **4,225 values**, including corrections outside the flagged audit rows.

The flagged Croatian and Macedonian queues are complete. Other completed queues include Latvian, Romanian, Slovak and several smaller regional queues. **Bosnian has 64 findings remaining**.

Latest translation correction: [5858b3a1f](https://github.com/wekan/wekan/commit/5858b3a1f261782771a9055eff3b608a5d14e66b), **2026-09-12**, fixes 10 Bosnian S3 and backup values. Repairs retain the MinIO choice, literal endpoints and region, secret-key authentication, SSL/TLS scope and board-specific backup. Meaning, token, exact-value, key-order, rendering and idempotent repair checks pass.
