...
| Pending review or repair | 3,463 |
| Total tracked | 20,081 |

**Repairs remain unfinished.** Restored and unflagged values still need validation.

Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **12,930** exact before/after values, including repairs outside the audit.

Latest translation fix: **2026-09-13**, local commit `437791daec1385912daadfe695d36fb87cd31cac` — five Volapük visibility, search, username and support strings repaired. Viewing/editing permissions, search scope and login requirement preserved; assembled wording remains low confidence.
