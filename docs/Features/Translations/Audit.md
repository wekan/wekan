...
| Pending review or repair | 2,615 |
...
Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **14,736** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-13**, local commit `1b930ff38` — replaced three English Aymara Hijri calendar labels, preserving civil/astronomical epoch and Saudi moon-sighting distinctions. Specialized wording is low confidence and awaits fluent-speaker review. The preceding Klingon fix `1044eebc9` completed the broader German-seed review; **1,189** Klingon values were repaired since resumption. Reviewed shared technical names remain protected. Wider repairs continue.
