...
Latest translation fix: **2026-09-15**, `b82d5761e` — replace the Finnish
Veps vertical-scrollbar control with a draft using the directly attested
vertical adjective and existing enable, scrolling and UI-bar terms. Source
confirms it controls scrollbar visibility across board, list, card and sidebar
containers. Four focused files pass (40 checks). Ledger 19,985; original pending
122 (Veps 4), restored 4 unchanged. The assembled compound remains low
confidence and the broader Veps review stays open.

The [correction ledger](../../../releases/translations/audited-corrections.json)
records contain **19,985** exact before/after values, including unflagged
