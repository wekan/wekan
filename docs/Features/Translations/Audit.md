...
Latest translation fix: **2026-09-14**, local commit `b479af98f` —
two Finnish Veps parent controls replaced with complete terminology drafts.
Change and hide remain distinct; full grammar is low confidence. Checks
pass; original pending 232, ledger 18,828. Native/browser review stays open.

The [correction ledger](../../../releases/translations/audited-corrections.json)
records contain **18,828** exact before/after values, including unflagged
