...
| Pending review or repair | 1,427 |
...
Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **15,927** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-13**, local commit `8a615aa40` — replaced 15 Italian-seeded Venetian query-validation and help messages. Preserved positive-integer limits, placeholders, login-link HTML, blank-field wildcard and image-only restriction. Direct wording remains low confidence pending fluent-speaker review. Venetian has **45** original findings remaining. Main Venda original findings are repaired in `180ca33c5`; restored and unflagged values still require validation. Wider repairs continue.
