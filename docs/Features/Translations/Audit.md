...
| Pending review or repair | 2,412 |
...
Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **14,939** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-13**, local commit `846fd29ad` — replaced fifteen further Zulu-seeded Venda privacy descriptions, invitations and rule actions with Tshivenda, preserving every source placeholder. Direct wording is low confidence and awaits fluent-speaker review. The preceding Luganda/Fijian fix is `9b78486c5`. Klingon fix `1044eebc9` completed the broader German-seed review; **1,189** Klingon values were repaired since resumption. Reviewed shared technical names remain protected. Wider repairs continue.
