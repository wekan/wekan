...
| Pending review or repair | 1,317 |
| Total tracked | 20,081 |

**Resumed at the maintainer’s request on 2026-09-13.** Reviewing and repairing the remaining local findings, beginning with Klingon. All **361** originally flagged Klingon findings are repaired. The broader check of **829** German-identical values is reviewed: **829** repaired, including the mistaken German `cron` retention corrected to the actual tool name **Cron**. Restored and unflagged translations still need validation.

Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **16,167** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-13**, local commit `a574de0e1` — replaced the remaining Zulu Veps chart-export popup title with native **Ve**, matching the repaired export label. All **16,167** correction records and vocabulary/token checks pass. Earlier account/email repairs (`88220b7a0`) remain recorded. **Low confidence:** composed subjects and SMTP success grammar need fluent review. Invitation-subject terminology, earlier compositions, broader wrong-language/script values, restored translations and browser verification remain outstanding.
