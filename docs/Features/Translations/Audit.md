...
Latest translation fix: **2026-09-14**, local commit `7dfbbecbd` —
French new-board invitation notification is repaired in Tamazight. Four
checks pass. Not-accepted-yet remains separate and pending; invitation
recency/full native grammar remain low confidence. Pending: 263.

The [correction ledger](../../../releases/translations/audited-corrections.json)
records contain **18,738** exact before/after values, including unflagged
...
| --- | ---: |
| zgh — Standard Moroccan Tamazight | 150 |
| iu — Inuktitut | 38 |
| nah — Nahuatl | 17 |
| tig — Tigre | 17 |
| wal — Wolaytta | 17 |
