...
| --- | ---: |
| Corrected | 15,538 |
| Restored pre-pull; awaiting validation | 3,918 |
| Reviewed; retained unchanged | 317 |
...
Restored Danish wording review (2026-09-14, latest `807ceeee2`): reviewed
140 values: 138 retained unchanged and two diagnostic meanings repaired.
Latest review preserves attachment scopes, invalid-upload cancellation,
logged-in-only support, known/unknown-user lockout and unlock-one/all actions.
Now 317 original findings are reviewed/retained and 3,918 restored values
