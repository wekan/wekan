...
Latest translation fix: **2026-09-15**, `1b35cd8b4` — replace the Finnish
Veps field-sum checkbox with the same primary-dictionary-attested arithmetic
addition and established list-top terminology as the numeric-total tooltip.
Source confirms the control is limited to number and currency fields. Four
focused files pass (40 checks). Ledger 19,984; original pending 123 (Veps 5),
restored 4 unchanged. Full compound/case grammar remains low confidence and the
broader Veps review stays open.

The [correction ledger](../../../releases/translations/audited-corrections.json)
records contain **19,984** exact before/after values, including unflagged
