...
| --- | ---: |
| Corrected | 15,538 |
| Restored pre-pull; awaiting validation | 3,948 |
| Reviewed; retained unchanged | 287 |
...
Restored Danish wording review (2026-09-14, latest `e5d7da30e`): reviewed
110 values: 108 retained unchanged and two diagnostic meanings repaired.
Now 287 original findings are reviewed/retained and 3,948 restored values
