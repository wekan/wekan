...
| --- | ---: |
| Corrected | 15,536 |
| Restored pre-pull; awaiting validation | 4,008 |
| Reviewed; retained unchanged | 229 |
...
Restored Danish wording review (2026-09-14, latest `9abcbc424`): reviewed
and retained 50 complete values unchanged in two batches, including no-undo
warnings, permitted-board due cards, activity locations, search errors,
directions, counts and technical settings. Now 229 original findings are
reviewed/retained and 4,008 restored values await validation. Correction
and pending counts are unchanged.
