...
Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **17,359** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-14**, local commit `4ceda3332` — repaired the unflagged Tamazight Edit-as-text label, removing the extra first qualifier absent from English and using native edit/text components. Full as-text phrasing and bound spelling remain **low confidence** pending fluent review. All **17,359** correction/rendering checks pass. Original counts are unchanged: **694** originals remain pending, including **551** Tamazight. Earlier composed wording and restored/unflagged values still need validation. Live browser verification was not run; no translations were pushed.
