...
| --- | ---: |
| Corrected | 15,565 |
| Restored pre-pull; awaiting validation | 802 |
| Reviewed; retained unchanged | 3,406 |
...
All **18,165** correction and **3,406** review records pass.
...
Latest unchanged review: **2026-09-14**, commit `9683042c4` — retained
30 Galician S3/MinIO settings and migration start/stop outcomes.
