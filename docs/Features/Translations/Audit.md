...
| Status | Audit keys |
| --- | ---: |
| Explicitly corrected | 5,621 |
| Original pull values restored to pre-pull local values | 4,061 |
| Reviewed and retained unchanged | 82 |
| Pending review or repair | 10,317 |
| Total tracked | 20,081 |

**Translation repairs remain unfinished.** These counts cover flagged findings; unflagged strings and restored values are not certified as correct.

Repairs cover wrong-language text, kanban terminology, omitted restrictions and warnings, JSON examples, placeholders, calendar names and search/date formatting. The correction history records **5,683 values**, including fixes outside the audit. Flagged Bosnian, Croatian, Macedonian, Slovenian (both locales), Latvian, Romanian and Slovak queues are complete.

Latest fix: [bb288913e](https://github.com/wekan/wekan/commit/bb288913e090ab4e310b2762710412877fbe53ce), **2026-09-13** — 35 Galician regional migration, monitoring, selection and warning corrections. Repairs distinguish paused from stopped migrations and preserve CPU thresholds, millisecond ranges, background continuation and permanent-deletion warnings. **65 regional findings remain.** Meaning, exact-value, placeholder, key-order and idempotency checks pass; live Meteor browser verification remains unavailable.
