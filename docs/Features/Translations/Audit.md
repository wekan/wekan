...
Latest translation fix: **2026-09-15**, `d0bf77715` — replace Arabic
automatic board-watching instruction, retaining the creation condition.
Four focused suites pass. Ledger 19,849; pending 167 (Tamazight 72),
restored 4 unchanged. Full conditional/passive agreement remains low
confidence; no active caller found. Broader reviews remain open.

The [correction ledger](../../../releases/translations/audited-corrections.json)
records contain **19,849** exact before/after values, including unflagged
...
| --- | ---: |
| zgh — Standard Moroccan Tamazight | 72 |
| iu — Inuktitut | 38 |
| nah — Nahuatl | 17 |
| tig — Tigre | 17 |
| wal — Wolaytta | 10 |
