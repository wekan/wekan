...
| Pending review or repair | 3,434 |
| Total tracked | 20,081 |

**Repairs remain unfinished.** Restored and unflagged values still need validation.

Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **12,960** exact before/after values, including repairs outside the audit.

Latest translation fix: **2026-09-13**, local commit `44f3d30f5f60bf117198457b30386b3438771db8` — nine Volapük card/workspace/account labels repaired. Hierarchy, custom-field, assignment and minicard-sort meanings preserved; software wording remains low confidence.
