...
| --- | ---: |
| Corrected | 15,561 |
| Restored pre-pull; awaiting validation | 1,823 |
| Reviewed; retained unchanged | 2,389 |
...
**18,157** correction and **2,389** review records pass. Three Esperanto
...
Latest unchanged review: **2026-09-14**, commit `4f0293f5c` — retained
25 correct Galician removal, rescue, shortcut and favorite values.
