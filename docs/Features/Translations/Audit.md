...
| Pending review or repair | 3,150 |
| Total tracked | 20,081 |

**Repairs remain unfinished.** Restored and unflagged values still need validation.

Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **13,313** exact before/after values, including repairs outside the audit.

Latest translation fix: **2026-09-13**, local commit `2aa937a036361c84b4dec41edc8bfa8233956bf4` — six German import/movement/label-removal activities (five flagged findings) replaced with Klingon, preserving all source and destination placeholder roles. Full software wording is low confidence and needs fluent-speaker validation.
