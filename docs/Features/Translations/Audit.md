...
Latest translation fix: **2026-09-13**, local commit `c4f4d86e7b2fafa781a267fe4be566b6d2f32685` (follow-up to `f25115fa0`) — ten Breton checklist-confirmation, favorite and migration findings repaired; **538 Breton findings remain**. Checklist/item distinctions and data-integrity checks are preserved; follow-up review clarifies star actions and data transfer terminology. Specialized terminology and grammatical wording need language review. Exact-value, placeholder, key-order and idempotency checks pass; live browser verification is unavailable.
