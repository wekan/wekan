...
Latest translation fix: **2026-09-14**, local commit `46090ad0e` —
French support-page enabled label is repaired using Tamazight assistance
vocabulary. Four checks pass; passive activated grammar and full native/
browser review remain low confidence and open. Pending: 262.

The [correction ledger](../../../releases/translations/audited-corrections.json)
records contain **18,739** exact before/after values, including unflagged
...
| --- | ---: |
| zgh — Standard Moroccan Tamazight | 149 |
| iu — Inuktitut | 38 |
| nah — Nahuatl | 17 |
| tig — Tigre | 17 |
| wal — Wolaytta | 17 |
