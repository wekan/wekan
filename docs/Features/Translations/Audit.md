...
Latest translation fix: **2026-09-15**, `14af25915` — Tamazight last-admin
warning replaces Arabic's wrong permission explanation. Preserve the
requirement for one administrator or more. Four focused suites pass.
Ledger 19,833; original pending 180 (Tamazight 85), restored 4 unchanged.
Minimum-count paraphrase and full grammar remain low confidence;
broader reviews remain open.

The [correction ledger](../../../releases/translations/audited-corrections.json)
records contain **19,833** exact before/after values, including unflagged
...
| --- | ---: |
| zgh — Standard Moroccan Tamazight | 85 |
| iu — Inuktitut | 38 |
| nah — Nahuatl | 17 |
| tig — Tigre | 17 |
| wal — Wolaytta | 10 |
