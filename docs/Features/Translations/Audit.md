...
| Pending review or repair | 2,040 |
...
Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **15,311** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-13**, local commit `1baefe89e` — replaced twenty-five further Zulu-seeded Venda import, member-mapping and checklist controls with Tshivenda, preserving every source placeholder. Direct wording is low confidence and awaits fluent-speaker review. The preceding Luganda/Fijian fix is `9b78486c5`. Klingon fix `1044eebc9` completed the broader German-seed review; **1,189** Klingon values were repaired since resumption. Reviewed shared technical names remain protected. Wider repairs continue.
