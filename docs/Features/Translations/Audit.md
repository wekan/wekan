...
| Pending review or repair | 2,604 |
...
Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **14,747** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-13**, local commit `2a750c70c` — replaced eight English Kirundi and Ndebele calendar labels, preserving Buddhist/Coptic identities and civil versus astronomical Hijri epochs. Specialized wording is low confidence and awaits fluent-speaker review. The preceding Setswana/Sesotho fix is `205a2317a`. Klingon fix `1044eebc9` completed the broader German-seed review; **1,189** Klingon values were repaired since resumption. Reviewed shared technical names remain protected. Wider repairs continue.
