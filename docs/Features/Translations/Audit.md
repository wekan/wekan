...
| Pending review or repair | 1,532 |
...
Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **15,822** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-13**, local commit `4171503bc` — replaced 16 Italian-seeded Venetian settings, deletion-prerequisite and due-view messages. Preserved numeric defaults, membership guards, irreversible warnings and permitted incomplete-card scope. Direct wording remains low confidence pending fluent-speaker review. Venetian has **150** original findings remaining. Main Venda original findings are repaired in `180ca33c5`; restored and unflagged values still require validation. Wider repairs continue.
