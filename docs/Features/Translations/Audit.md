...
Latest translation fix: **2026-09-14**, local commit `af4faeb70` —
Tamazight field-total checkbox replaces French, preserving aggregate and
list-top meanings. Four checks pass; full native/browser grammar remains
low confidence. Pending: 258.

The [correction ledger](../../../releases/translations/audited-corrections.json)
records contain **18,754** exact before/after values, including unflagged
