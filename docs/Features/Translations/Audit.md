...
Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **16,124** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-13**, local commit `a14b0ffc4` — replaced six Finnish Veps navigation, error and version/create labels with native software terminology; the errors plural is dictionary-verified. All **16,124** correction records and vocabulary/token checks pass. These unflagged repairs leave original pending counts unchanged. Frequency/year-warning/lockout/calendar compositions, broader wrong-language/script values, restored translations and browser verification remain outstanding.
