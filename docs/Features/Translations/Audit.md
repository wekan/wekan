...
Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **16,104** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-13**, local commit `5f011f219` — repaired eight Finnish Veps navigation/file control labels with verified native software vocabulary. Download's explicit save-as-file wording is distinct from upload. All **16,104** correction records and vocabulary/token checks pass. These unflagged repairs leave original pending counts unchanged. Year-warning digit terminology, lockout/calendar compositions, broader wrong-language/script values, restored translations and browser verification remain outstanding.
