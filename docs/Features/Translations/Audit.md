...
| Pending review or repair | 3,422 |
| Total tracked | 20,081 |

**Repairs remain unfinished.** Restored and unflagged values still need validation.

Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **12,972** exact before/after values, including repairs outside the audit.

Latest translation fix: **2026-09-13**, local commit `a797a67231e19225b19a3ed0d7845c9ec482c5cd` — twelve Volapük scheduled-job/migration messages repaired. Start/resume, retry and failed/paused distinctions preserved; assembled wording remains low confidence.
