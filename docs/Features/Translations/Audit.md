...
Latest translation fix: **2026-09-15**, `636dae2df` — Tamazight quick-
access hint replaces Arabic, keeping star-board action and shortcut location.
Four focused suites pass. Ledger 19,819; original pending 188 (Tamazight
93), restored 4 unchanged. Software shortcut adaptation and complete
purpose clause remain low confidence; broader reviews remain open.

The [correction ledger](../../../releases/translations/audited-corrections.json)
records contain **19,819** exact before/after values, including unflagged
...
| --- | ---: |
| zgh — Standard Moroccan Tamazight | 93 |
| iu — Inuktitut | 38 |
| nah — Nahuatl | 17 |
| tig — Tigre | 17 |
| wal — Wolaytta | 10 |
