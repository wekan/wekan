...
| Pending review or repair | 1,329 |
| Total tracked | 20,081 |

**Resumed at the maintainer’s request on 2026-09-13.** Reviewing and repairing the remaining local findings, beginning with Klingon. All **361** originally flagged Klingon findings are repaired. The broader check of **829** German-identical values is reviewed: **829** repaired, including the mistaken German `cron` retention corrected to the actual tool name **Cron**. Restored and unflagged translations still need validation.

Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **16,136** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-13**, local commit `e6b39cc68` — replaced seven Finnish Veps rename/permission/filter/no-errors labels, resolving six original findings. Native software vocabulary and dictionary forms are verified; **low confidence:** composed permission and no-errors grammar needs fluent review. All **16,136** correction records and vocabulary/token checks pass. Frequency/year-warning/lockout/calendar compositions, broader wrong-language/script values, restored translations and browser verification remain outstanding.
