...
| Pending review or repair | 1,703 |
...
Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **15,651** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-13**, local commit `e8f9a898b` — replaced 25 Italian-seeded Venetian board/card controls and copy instructions, preserving irreversible warnings, archive recovery, interpolation tokens and JSON property names. Direct wording remains low confidence pending fluent-speaker review. Venetian has **321** original findings remaining. Main Venda original findings are repaired in `180ca33c5`; restored and unflagged values still require validation. Wider repairs continue.
