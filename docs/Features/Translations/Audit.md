...
Latest translation fix: **2026-09-15**, `260258983` — Tamazight keyboard
shortcut heading and enabled/disabled messages replace Arabic. Preserve
current state and opposite click action. Four focused suites pass. Ledger
19,831; original pending 182 (Tamazight 87), restored 4 unchanged.
The heading was unflagged. Software adaptation, derived passive and plural
pronoun grammar remain low confidence; broader reviews remain open.

The [correction ledger](../../../releases/translations/audited-corrections.json)
records contain **19,831** exact before/after values, including unflagged
...
| --- | ---: |
| zgh — Standard Moroccan Tamazight | 87 |
| iu — Inuktitut | 38 |
| nah — Nahuatl | 17 |
| tig — Tigre | 17 |
| wal — Wolaytta | 10 |
