...
| Status | Audit keys |
| --- | ---: |
| Explicitly corrected | 6,447 |
| Restored pre-pull values awaiting further validation | 4,059 |
| Reviewed and retained unchanged | 121 |
| Pending review or repair | 9,454 |
| Total tracked | 20,081 |

**Translation repairs remain unfinished.** These counts cover flagged findings; unflagged strings and restored values are not certified as correct.

Fixes cover wrong-language text, terminology, missing warnings, JSON examples, placeholders and calendar/search formatting. The correction history records **6,509 values**, including fixes outside the audit. Flagged queues are complete for Bosnian, Croatian, Macedonian, both Slovenian locales, Latvian, Romanian, Slovak, both Galician locales and Asturian.

Latest fix: [9c5f760c7](https://github.com/wekan/wekan/commit/9c5f760c77b40c4a5ccf815f03f7a27489e41519), **2026-09-13** — six Aragonese counts, organization-admin, OTP, overdue and image-paste messages repaired, preserving spacing, tokens and image-only restriction. **86 Aragonese findings remain.** Meaning, exact-value, placeholder, key-order and idempotency checks pass; Aragonese and Asturian wording need native-speaker review. Live Meteor browser verification remains unavailable.
