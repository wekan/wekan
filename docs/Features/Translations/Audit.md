...
| Status | Audit keys |
| --- | ---: |
| Explicitly corrected | 6,486 |
| Restored pre-pull values awaiting further validation | 4,059 |
| Reviewed and retained unchanged | 130 |
| Pending review or repair | 9,406 |
| Total tracked | 20,081 |

**Translation repairs remain unfinished.** These counts cover flagged findings; unflagged strings and restored values are not certified as correct.

Fixes cover wrong-language text, terminology, missing warnings, JSON examples, placeholders and calendar/search formatting. The correction history records **6,548 values**, including fixes outside the audit. Flagged queues are complete for Bosnian, Croatian, Macedonian, both Slovenian locales, Latvian, Romanian, Slovak, both Galician locales and Asturian.

Latest fix: [41ee5e7d0](https://github.com/wekan/wekan/commit/41ee5e7d0790e5d91adf2b363dbc4fbbc751e8e2), **2026-09-13** — six Aragonese search-sidebar and minicard display settings repaired, distinguishing list, parent card, subtasks and checklist controls. **38 Aragonese findings remain.** Meaning, exact-value, placeholder, key-order and idempotency checks pass; Aragonese and Asturian wording need native-speaker review. Live Meteor browser verification remains unavailable.
