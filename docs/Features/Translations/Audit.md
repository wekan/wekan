...
Latest translation fix: **2026-09-15**, `8b44ebd33` — Tamazight duplicate-list
confirmation translated with same-name AND no-card deletion restrictions.
Four focused suites pass. Ledger 19,775; original pending 208 (zgh 105),
restored 4 unchanged. Full passive/shared-name grammar and all other
uncertain/restored findings remain open.

The [correction ledger](../../../releases/translations/audited-corrections.json)
records contain **19,775** exact before/after values, including unflagged
...
| --- | ---: |
| zgh — Standard Moroccan Tamazight | 105 |
| iu — Inuktitut | 38 |
| nah — Nahuatl | 17 |
| tig — Tigre | 17 |
| wal — Wolaytta | 17 |
