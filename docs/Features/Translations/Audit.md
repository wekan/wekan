...
Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **15,977** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-13**, local commit `b077128b2` — replaced four unflagged Finnish-seeded Veps date-unit labels with Veps vocabulary from the language word list. Composed-UI inflection requires review. Previous Corsican review `ad209a3cb` retained attested wording; Klingon correction `1c53f96ad` fixed the mistaken Cron retention. Original Venetian and main Venda findings are repaired. Restored/unflagged values and low-confidence wording still require validation; wider repairs continue.
