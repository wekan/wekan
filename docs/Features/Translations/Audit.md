...
| Pending review or repair | 1,289 |
| Total tracked | 20,081 |

**Resumed at the maintainer’s request on 2026-09-13.** Reviewing and repairing the remaining local findings, beginning with Klingon. All **361** originally flagged Klingon findings are repaired. The broader check of **829** German-identical values is reviewed: **829** repaired, including the mistaken German `cron` retention corrected to the actual tool name **Cron**. Restored and unflagged translations still need validation.

Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **16,213** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-13**, local commit `198f7a0f5` — replaced **12** Finnish Veps list-position, sorting, duplicate-cleanup and missing-list/result values, resolving **10** original findings. Selected-list left/right positions and empty-only cleanup remain distinct. All **16,213** correction records, placeholders, key order and actual i18next rendering checks pass. Native dictionary and MediaWiki vocabulary evidence is recorded per key. **Low confidence:** composed UI grammar and derived plural genitives need fluent review, alongside earlier activity/calendar/account/email wording. Veps has **548** pending original findings. Translation repairs have resumed after the completed mirror-menu work; broader wrong-language/script and restored-value validation remain outstanding.
