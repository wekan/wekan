...
| Pending review or repair | 1,655 |
...
Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **15,699** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-13**, local commit `a35ca4249` — replaced 20 Italian-seeded Venetian membership, visibility and list-behavior messages. Preserved access restrictions, archive recovery, notification behavior and invitation placeholders. Direct wording remains low confidence pending fluent-speaker review. Venetian has **273** original findings remaining. Main Venda original findings are repaired in `180ca33c5`; restored and unflagged values still require validation. Wider repairs continue.
