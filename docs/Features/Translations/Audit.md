...
Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **16,129** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-13**, local commit `22c70a853` — replaced five Finnish/Zulu Veps change, close, export, import and rename actions with attested native software commands. Import/export and close/delete remain distinct. All **16,129** correction records and vocabulary/token checks pass. These unflagged repairs leave original pending counts unchanged. Frequency/year-warning/lockout/calendar compositions, broader wrong-language/script values, restored translations and browser verification remain outstanding.
