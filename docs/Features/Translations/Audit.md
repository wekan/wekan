...
| Status | Audit keys |
| --- | ---: |
| Explicitly corrected | 5,273 |
| Original pull values restored to pre-pull local values | 4,061 |
| Reviewed and retained unchanged | 78 |
| Pending review or repair | 10,669 |
| Total tracked | 20,081 |

**Translation repairs remain unfinished.** These counts cover flagged findings; unflagged strings and restored values are not certified as correct.

Repairs cover wrong-language text, kanban terminology, omitted restrictions and warnings, JSON examples, placeholders, calendar names and search/date formatting. The correction history records **5,335 values**, including fixes outside the audit. Flagged Bosnian, Croatian, Macedonian, Slovenian (both locales), Latvian, Romanian and Slovak queues are complete.

Latest fix: [c5429b159](https://github.com/wekan/wekan/commit/c5429b159d82ee35810e014079c7c7ba5102e731), **2026-09-13** — ten Galician regional membership and list corrections. Repairs preserve the last-admin restriction, board-exit warning, archive restoration and irreversible deletion with activity loss. **417 regional findings remain.** Meaning, exact-value, placeholder, key-order and idempotency checks pass; live Meteor browser verification remains unavailable.
