...
| Pending review or repair | 2,612 |
...
Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **14,739** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-13**, local commit `205a2317a` — replaced three English calendar labels in Setswana and Sesotho, retaining Coptic identity and the civil Hijri epoch distinction. Specialized wording is low confidence and awaits fluent-speaker review. The preceding Aymara fix is `1b930ff38`. Klingon fix `1044eebc9` completed the broader German-seed review; **1,189** Klingon values were repaired since resumption. Reviewed shared technical names remain protected. Wider repairs continue.
