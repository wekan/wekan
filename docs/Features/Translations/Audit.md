...
| Pending review or repair | 1,343 |
| Total tracked | 20,081 |

**Resumed at the maintainer’s request on 2026-09-13.** Reviewing and repairing the remaining local findings, beginning with Klingon. All **361** originally flagged Klingon findings are repaired. The broader check of **829** German-identical values is reviewed: **829** repaired, including the mistaken German `cron` retention corrected to the actual tool name **Cron**. Restored and unflagged translations still need validation.

Fixed: wrong-language text, terminology, warnings, placeholders and JSON/calendar/search formatting. [Correction records](../../../releases/translations/audited-corrections.json) contain **16,079** exact before/after values, including unflagged repairs.

Latest translation fix: **2026-09-13**, local commit `1ca7941c2` — repaired six Finnish Veps password/account labels with software-attested vocabulary, including repeat/mismatch/forgotten-password wording and SMTP username. **Low confidence:** the composed required-fields message needs fluent review. All **16,079** correction records and vocabulary/token checks pass. Veps has 602 original findings remaining. Year-warning digit terminology, calendar compositions, broader wrong-language/script values, restored translations and browser verification remain outstanding.
