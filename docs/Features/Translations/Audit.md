...
| Status | Audit keys |
| --- | ---: |
| Explicitly corrected | 6,205 |
| Restored pre-pull values awaiting further validation | 4,059 |
| Reviewed and retained unchanged | 100 |
| Pending review or repair | 9,717 |
| Total tracked | 20,081 |

**Translation repairs remain unfinished.** These counts cover flagged findings; unflagged strings and restored values are not certified as correct.

Fixes cover wrong-language text, terminology, missing warnings, JSON examples, placeholders and calendar/search formatting. The correction history records **6,267 values**, including fixes outside the audit. Flagged Bosnian, Croatian, Macedonian, Slovenian (both locales), Latvian, Romanian, Slovak both Galician and Asturian queues are complete.

Latest fix: [6147f72f6](https://github.com/wekan/wekan/commit/6147f72f65560c8ac7da33ea746acd7582ce5a27), **2026-09-13** — six Asturian advanced-filter and Hijri-calendar corrections; literal expressions, escaping, operator order and calendar variants preserved. **No flagged Asturian findings remain.** Meaning, exact-value, placeholder, key-order and idempotency checks pass; Asturian wording needs native-speaker review. Live Meteor browser verification remains unavailable.
