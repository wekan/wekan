...
Latest translation fix: **2026-09-15**, `08e7092c3` — replace established
File, User, Name, Label, Organization, Team, Path, Status, Size, Color and
Count components across all 193 matching Tigre values. English source-sense
...
2,592 non-English Tigre values, 244 are byte-for-byte identical to Tigrinya;
22 are corpus-attested shared terms and 222 remain unclassified, including 25
...
records contain **21,888** exact before/after values, including unflagged
