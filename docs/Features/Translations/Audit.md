...
contain **18,684** exact before/after values, including unflagged repairs.
...
open in `5400a0ce9`. Current pending/restored counts are 286/9.
...
Current pending/restored counts are 286/9.

Latest translation fix: **2026-09-14**, local commit `bd4a6a494` —
Tamazight Hebrew calendar uses an adapted native noun/adjective label.
The adjective is attested in directly fetched native prose; full calendar
naming remains low confidence and needs broader native/browser review.
All 18,684 corrections and focused checks pass. Current counts are
286 pending and 9 restored. Buddhist repair is in `8422804a4`.
...
open. Counts are 286 pending and 9 restored. Earlier S3 review is in
...
pending/restored counts are 286/9.
...
| --- | ---: |
| zgh — Standard Moroccan Tamazight | 171 |
| iu — Inuktitut | 40 |
| nah — Nahuatl | 17 |
| tig — Tigre | 17 |
| wal — Wolaytta | 17 |
