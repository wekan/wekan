...
Latest translation fix: **2026-09-15**, `f1b12cc66` — repair eight
Tigre Rename and board-background controls with corpus-attested name, change,
image and background terminology. Background compound order and its derived
plural remain marked for fluent review. Ledger 20,922; the preceding status
batch is `b4586ba97`. The Veps seed review remains complete.

The tracked Tigre calendar queue being empty does not certify the locale. Of
2,592 non-English Tigre values, 611 are byte-for-byte identical to Tigrinya;
20 are corpus-attested shared terms and 591 remain unclassified, including 84
...
records contain **20,922** exact before/after values, including unflagged
