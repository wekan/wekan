...
Latest translation fix: **2026-09-15**, `4f07f43d8` — Tamazight label
deletion warning replaces Arabic. Preserve no undo, removal of this label
from all cards and destruction of its history in a separate clause. Four
focused suites pass. Ledger 19,828; original pending 184 (Tamazight 89),
restored 4 unchanged. Complete agreement and contextual grammar remain
low confidence; broader reviews remain open.

The [correction ledger](../../../releases/translations/audited-corrections.json)
records contain **19,828** exact before/after values, including unflagged
...
| --- | ---: |
| zgh — Standard Moroccan Tamazight | 89 |
| iu — Inuktitut | 38 |
| nah — Nahuatl | 17 |
| tig — Tigre | 17 |
| wal — Wolaytta | 10 |
