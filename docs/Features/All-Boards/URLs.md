...
([Admin Panel URLs](../Page/Admin-Panel-URLs.md)), one list rather than a helper per
...
- [The Admin Panel's URLs](../Page/Admin-Panel-URLs.md) — the same idea, for the Admin Panel
