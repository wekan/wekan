...
has no meaning to give it. As with the [Home](../Board/Home.md) drag, the type is read
...
- [Home](../Board/Home.md) — the other mark on a board, and the other drag with a type of its own
- [All Boards](All-Boards.md) — the page the tiles are on
- [All Boards URLs](URLs.md) — the addresses that made bookmarking possible
- [The header](../Header/Header.md) — the bar the group sits in
