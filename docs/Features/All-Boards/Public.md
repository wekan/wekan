...
[the Table page design](../Page/Table.md), and this page describes only what is different
about this one.
...
[Table.md's own list](../Page/Table.md#related-files).
...
- [The Table page design](../Page/Table.md) — everything shared
