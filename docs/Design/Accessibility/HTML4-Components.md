...
| Attachment | safe name, detected type, byte size, content scope and available representations | text metadata plus separate purpose-signed `Preview` and `Download` POST controls | attachment thumbnail, slideshow and download action |
