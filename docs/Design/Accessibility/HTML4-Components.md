...
| --- | --- |
| `/sign-in`, `/sign-up`, `/forgot-password` | Complete cookieless sign-in and registration forms plus uniform, bounded and independently rate-limited password-recovery requests. Reset, enrollment, verification and resend-token operations remain |
