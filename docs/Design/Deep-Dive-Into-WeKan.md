...
- CPU: amd64, arm64, s390x, Source Bundle at [Raspberry Pi](../Platforms/FOSS/HW/RaspberryPi/Raspberry-Pi.md)
- Windows On-Premise: [Offline](../Platforms/Propietary/OS/Windows/Offline.md)
- Mac: Docker, or at [Mac](../Platforms/Propietary/OS/Mac)
